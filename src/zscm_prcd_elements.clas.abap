...
"! <em>cds_zsd_prcd_elements</em>
CLASS zscm_prcd_elements DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">z_i_PRCD_ELEMENTSType</p>
      BEGIN OF tys_z_i_prcd_elementstype,
        ...
        "! Kdatu
        kdatu                 TYPE c LENGTH 14,
        "! Krech
        krech                 TYPE c LENGTH 3,
        "! Kawrt
        kawrt                 TYPE p LENGTH 13 DECIMALS 9,
        "! Kbetr
        kbetr                 TYPE p LENGTH 13 DECIMALS 9,
        "! Waers
        ...
        "! Kumza
        kumza                 TYPE p LENGTH 6 DECIMALS 0,
        "! Kumne
        kumne                 TYPE p LENGTH 6 DECIMALS 0,
        "! Kntyp
        ...
        "! Kdiff
        kdiff                 TYPE p LENGTH 4 DECIMALS 3,
        "! Kwert
        kwert                 TYPE p LENGTH 9 DECIMALS 3,
        "! Waerk
        ...
        "! Kzbzg
        kzbzg                 TYPE c LENGTH 3,
        "! Kstbs
        kstbs                 TYPE p LENGTH 13 DECIMALS 9,
        "! Konms
        ...
        "! KwertK
        kwert_k               TYPE p LENGTH 9 DECIMALS 3,
        "! Kfkiv
        ...
        "! KawrtK
        kawrt_k               TYPE p LENGTH 13 DECIMALS 9,
        "! Kunnr
      ...
      END OF tys_z_i_prcd_elementstype,
      "! <p class="shorttext synchronized">List of z_i_PRCD_ELEMENTSType</p>
      tyt_z_i_prcd_elementstype TYPE STANDARD TABLE OF tys_z_i_prcd_elementstype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! z_i_PRCD_ELEMENTS
        "! <br/> Collection of type 'z_i_PRCD_ELEMENTSType'
        z_i_prcd_elements          TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_PRCD_ELEMENTS',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for z_i_PRCD_ELEMENTSType</p>
        "! See also structure type {@link ..tys_z_i_prcd_elementstype}
        BEGIN OF z_i_prcd_elementstype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_prcd_elementstype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define z_i_PRCD_ELEMENTSType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_prcd_elementstype RAISING /iwbep/cx_gateway.

ENDCLASS.


CLASS zscm_prcd_elements IMPLEMENTATION.

  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_prcd_elements' ) ##NO_TEXT.
  ...
  METHOD def_z_i_prcd_elementstype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_PRCD_ELEMENTSTYPE'
                                    is_structure              = VALUE tys_z_i_prcd_elementstype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'z_i_PRCD_ELEMENTSType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_PRCD_ELEMENTS' ).
    lo_entity_set->set_edm_name( 'z_i_PRCD_ELEMENTS' ) ##NO_TEXT.
