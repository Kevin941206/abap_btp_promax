...
CLASS zscm_t023 DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_T023TType</p>
      BEGIN OF tys_z_i_t_023_ttype,
        "! Delete_mc
        ...
        "! <em>Key property</em> Matkl
        matkl     TYPE c LENGTH 9,
        "! Wgbez
        wgbez     TYPE c LENGTH 20,
        "! Wgbez60
        wgbez_60  TYPE c LENGTH 60,
      END OF tys_z_i_t_023_ttype,
      "! <p class="shorttext synchronized">List of Z_I_T023TType</p>
      tyt_z_i_t_023_ttype TYPE STANDARD TABLE OF tys_z_i_t_023_ttype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_T023Type</p>
      BEGIN OF tys_z_i_t_023_type,
        "! Delete_mc
        delete_mc   TYPE abap_bool,
        "! Update_mc
        update_mc   TYPE abap_bool,
        ...
        "! Lref3
        lref_3      TYPE c LENGTH 3,
        "! Wwgda
        wwgda       TYPE c LENGTH 18,
        "! Wwgpa
        wwgpa       TYPE c LENGTH 18,
        "! Abtnr
        ...
        "! Ekwsl
        ekwsl       TYPE c LENGTH 4,
        "! Anlkl
        anlkl       TYPE c LENGTH 8,
        "! DefSchdsc
        def_schdsc  TYPE c LENGTH 6,
        "! PriceGroup
        price_group TYPE c LENGTH 6,
      END OF tys_z_i_t_023_type,
      "! <p class="shorttext synchronized">List of Z_I_T023Type</p>
      tyt_z_i_t_023_type TYPE STANDARD TABLE OF tys_z_i_t_023_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_T023_T023TType</p>
      BEGIN OF tys_z_i_t_023_t_023_ttype,
        "! <em>Key property</em> matkl
        matkl       TYPE c LENGTH 9,
        "! spart
        spart       TYPE c LENGTH 2,
        ...
        "! wgbez
        wgbez       TYPE c LENGTH 20,
      END OF tys_z_i_t_023_t_023_ttype,
      "! <p class="shorttext synchronized">List of Z_I_T023_T023TType</p>
      tyt_z_i_t_023_t_023_ttype TYPE STANDARD TABLE OF tys_z_i_t_023_t_023_ttype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_T023
        "! <br/> Collection of type 'Z_I_T023Type'
        z_i_t_023                  TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_T_023',
        "! Z_I_T023T
        "! <br/> Collection of type 'Z_I_T023TType'
        z_i_t_023_t                TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_T_023_T',
        "! Z_I_T023_T023T
        "! <br/> Collection of type 'Z_I_T023_T023TType'
        z_i_t_023_t_023_t          TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_T_023_T_023_T',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_T023TType</p>
        "! See also structure type {@link ..tys_z_i_t_023_ttype}
        BEGIN OF z_i_t_023_ttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_t_023_ttype,
        "! <p class="shorttext synchronized">Internal names for Z_I_T023Type</p>
        "! See also structure type {@link ..tys_z_i_t_023_type}
        BEGIN OF z_i_t_023_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_t_023_type,
        "! <p class="shorttext synchronized">Internal names for Z_I_T023_T023TType</p>
        "! See also structure type {@link ..tys_z_i_t_023_t_023_ttype}
        BEGIN OF z_i_t_023_t_023_ttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_t_023_t_023_ttype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_T023TType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_t_023_ttype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_T023Type</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_t_023_type RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_T023_T023TType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_t_023_t_023_ttype RAISING /iwbep/cx_gateway.

ENDCLASS.



CLASS ZSCM_T023 IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_t023' ) ##NO_TEXT.
  ...
  METHOD def_z_i_t_023_ttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_T_023_TTYPE'
                                    is_structure              = VALUE tys_z_i_t_023_ttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_T023TType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_T_023_T' ).
    lo_entity_set->set_edm_name( 'Z_I_T023T' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'WGBEZ' ).
    lo_primitive_property->set_edm_name( 'Wgbez' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WGBEZ_60' ).
    lo_primitive_property->set_edm_name( 'Wgbez60' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
  ...
  METHOD def_z_i_t_023_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_T_023_TYPE'
                                    is_structure              = VALUE tys_z_i_t_023_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_T023Type' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_T_023' ).
    lo_entity_set->set_edm_name( 'Z_I_T023' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'LREF_3' ).
    lo_primitive_property->set_edm_name( 'Lref3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WWGDA' ).
    lo_primitive_property->set_edm_name( 'Wwgda' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WWGPA' ).
    lo_primitive_property->set_edm_name( 'Wwgpa' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'EKWSL' ).
    lo_primitive_property->set_edm_name( 'Ekwsl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ANLKL' ).
    lo_primitive_property->set_edm_name( 'Anlkl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 8 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DEF_SCHDSC' ).
    lo_primitive_property->set_edm_name( 'DefSchdsc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRICE_GROUP' ).
    lo_primitive_property->set_edm_name( 'PriceGroup' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_t_023_t_023_ttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_T_023_T_023_TTYPE'
                                    is_structure              = VALUE tys_z_i_t_023_t_023_ttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_T023_T023TType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_T_023_T_023_T' ).
    lo_entity_set->set_edm_name( 'Z_I_T023_T023T' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'J_1_BNBM' ).
    lo_primitive_property->set_edm_name( 'j_1bnbm' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DEF_SCHDSC' ).
    lo_primitive_property->set_edm_name( 'def_schdsc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRICE_GROUP' ).
    lo_primitive_property->set_edm_name( 'price_group' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
