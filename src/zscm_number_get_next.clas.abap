...
"! <em>ZFM_NUMBER_GET_NEXT_SRV</em>
CLASS zscm_number_get_next DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      BEGIN OF tys_header,
        "! <em>Key property</em> Object
        object    TYPE c LENGTH 10,
        "! <em>Key property</em> Nrrangenr
...
CLASS ZSCM_NUMBER_GET_NEXT IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'ZFM_NUMBER_GET_NEXT_SRV' ) ##NO_TEXT.
  ...
  METHOD def_header.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'NRRANGENR' ).
    lo_primitive_property->set_edm_name( 'Nrrangenr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
