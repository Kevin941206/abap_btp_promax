...
"! <em>cds_zsd_po_view_confirmed</em>
CLASS zscm_po_view_confirmed DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_TVTYTType</p>
      BEGIN OF tys_z_i_tvtyttype,
      ...
      END OF tys_z_i_tvtyttype,
      "! <p class="shorttext synchronized">List of Z_I_TVTYTType</p>
      tyt_z_i_tvtyttype TYPE STANDARD TABLE OF tys_z_i_tvtyttype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_TVTYT
        "! <br/> Collection of type 'Z_I_TVTYTType'
        z_i_tvtyt                  TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_TVTYT',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_TVTYTType</p>
        "! See also structure type {@link ..tys_z_i_tvtyttype}
        BEGIN OF z_i_tvtyttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_tvtyttype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_TVTYTType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_tvtyttype RAISING /iwbep/cx_gateway.

ENDCLASS.



CLASS ZSCM_PO_VIEW_CONFIRMED IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_po_view_confirmed' ) ##NO_TEXT.
  ...
  METHOD def_z_i_tvtyttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_TVTYTTYPE'
                                    is_structure              = VALUE tys_z_i_tvtyttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_TVTYTType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_TVTYT' ).
    lo_entity_set->set_edm_name( 'Z_I_TVTYT' ) ##NO_TEXT.
