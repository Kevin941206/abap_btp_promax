...
"! <em>cds_zsd_zvts_po_pdf</em>
CLASS zscm_zvts_po_pdf DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_NASTType</p>
      BEGIN OF tys_z_i_nasttype,
        "! <em>Key property</em> Kappl
        kappl      TYPE c LENGTH 2,
        "! <em>Key property</em> Objky
        objky      TYPE c LENGTH 30,
        ...
        "! <em>Key property</em> Erdat
        erdat      TYPE datn,
        "! <em>Key property</em> Eruhr
        eruhr      TYPE timn,
        "! Adrnr
        ...
        "! Anzal
        anzal      TYPE p LENGTH 2 DECIMALS 0,
        "! Vsztp
        vsztp      TYPE c LENGTH 1,
        "! Vsdat
        vsdat      TYPE datn,
        "! Vsura
        vsura      TYPE timn,
        ...
        "! Aktiv
        aktiv      TYPE c LENGTH 1,
        "! Tcode
        tcode      TYPE c LENGTH 4,
        "! Ldest
        ldest      TYPE c LENGTH 4,
        "! Dsnam
        dsnam      TYPE c LENGTH 6,
        "! Dsuf1
        dsuf_1     TYPE c LENGTH 4,
        "! Dsuf2
        dsuf_2     TYPE c LENGTH 12,
        "! Dimme
        dimme      TYPE abap_bool,
        "! Delet
        delet      TYPE abap_bool,
        "! Telfx
        ...
        "! Aende
        aende      TYPE c LENGTH 1,
        "! Repet
        repet      TYPE c LENGTH 1,
        "! Repid
        repid      TYPE c LENGTH 8,
        "! Pfld1
        pfld_1     TYPE c LENGTH 30,
        "! Pfld2
        pfld_2     TYPE c LENGTH 30,
        "! Pfld3
        pfld_3     TYPE c LENGTH 30,
        "! Pfld4
        pfld_4     TYPE c LENGTH 30,
        "! Pfld5
        pfld_5     TYPE c LENGTH 30,
        "! Pmid1
        pmid_1     TYPE c LENGTH 3,
        "! Pmid2
        pmid_2     TYPE c LENGTH 3,
        "! Pmid3
        pmid_3     TYPE c LENGTH 3,
        "! Pmid4
        pmid_4     TYPE c LENGTH 3,
        "! Pmid5
        pmid_5     TYPE c LENGTH 3,
        "! Tdname
        ...
        "! Edikey
        edikey     TYPE c LENGTH 8,
        "! Editrans
        editrans   TYPE c LENGTH 6,
        "! Snddr
        snddr      TYPE abap_bool,
        "! Sndex
        sndex      TYPE c LENGTH 1,
        "! Sndcp
        sndcp      TYPE c LENGTH 1,
        "! Sndbc
        sndbc      TYPE c LENGTH 1,
        "! Forfb
        forfb      TYPE c LENGTH 1,
        "! Prifb
        prifb      TYPE c LENGTH 1,
        "! Acall
        acall      TYPE c LENGTH 1,
        "! Objac
        objac      TYPE c LENGTH 1,
        "! Objrr
        objrr      TYPE c LENGTH 1,
        "! Objrn
        objrn      TYPE c LENGTH 1,
        "! Outfl
        outfl      TYPE c LENGTH 1,
        "! Objsns
        objsns     TYPE c LENGTH 1,
        "! Objpri
        objpri     TYPE c LENGTH 1,
        "! Objcp
        objcp      TYPE c LENGTH 1,
        "! Nauto
        nauto      TYPE abap_bool,
        "! Tdreceiver
        tdreceiver TYPE c LENGTH 12,
        "! Tddivision
        tddivision TYPE c LENGTH 12,
        "! Tdocover
        tdocover   TYPE c LENGTH 1,
        "! Tdcovtitle
        tdcovtitle TYPE c LENGTH 68,
        "! Tdautority
        tdautority TYPE c LENGTH 12,
        "! Tdarmod
        tdarmod    TYPE c LENGTH 1,
        "! Optarcnr
        optarcnr   TYPE c LENGTH 10,
        "! Cmfpnr
        cmfpnr     TYPE c LENGTH 12,
        "! Usrnam
        usrnam     TYPE c LENGTH 12,
        "! Event
        event      TYPE c LENGTH 32,
        "! Sort1
        sort_1     TYPE c LENGTH 20,
        "! Sort2
        sort_2     TYPE c LENGTH 20,
        "! Sort3
        sort_3     TYPE c LENGTH 20,
        "! Objtype
        objtype    TYPE c LENGTH 10,
        "! Tdschedule
        tdschedule TYPE c LENGTH 3,
        "! Tland
        tland      TYPE c LENGTH 3,
        "! Dataaging
        dataaging  TYPE datn,
      END OF tys_z_i_nasttype,
      "! <p class="shorttext synchronized">List of Z_I_NASTType</p>
      tyt_z_i_nasttype TYPE STANDARD TABLE OF tys_z_i_nasttype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_TNAPRType</p>
      BEGIN OF tys_z_i_tnaprtype,
        "! <em>Key property</em> Kschl
        kschl      TYPE c LENGTH 4,
        "! <em>Key property</em> Nacha
        nacha      TYPE c LENGTH 1,
        "! <em>Key property</em> Kappl
        kappl      TYPE c LENGTH 2,
        "! Pgnam
        pgnam      TYPE c LENGTH 40,
        "! Ronam
        ronam      TYPE c LENGTH 30,
        "! Fonam
        fonam      TYPE c LENGTH 16,
        "! Pgnam2
        pgnam_2    TYPE c LENGTH 40,
        "! Ronam2
        ronam_2    TYPE c LENGTH 30,
        "! Fonam2
        fonam_2    TYPE c LENGTH 16,
        "! Pgnam3
        pgnam_3    TYPE c LENGTH 40,
        "! Ronam3
        ronam_3    TYPE c LENGTH 30,
        "! Fonam3
        fonam_3    TYPE c LENGTH 16,
        "! Pgnam4
        pgnam_4    TYPE c LENGTH 40,
        "! Ronam4
        ronam_4    TYPE c LENGTH 30,
        "! Fonam4
        fonam_4    TYPE c LENGTH 16,
        "! Pgnam5
        pgnam_5    TYPE c LENGTH 40,
        "! Ronam5
        ronam_5    TYPE c LENGTH 30,
        "! Fonam5
        fonam_5    TYPE c LENGTH 16,
        "! Funcname
        funcname   TYPE c LENGTH 30,
        "! Sform
        sform      TYPE c LENGTH 30,
        "! Formtype
        formtype   TYPE c LENGTH 1,
        "! Sform2
        sform_2    TYPE c LENGTH 30,
        "! Formtype2
        formtype_2 TYPE c LENGTH 1,
        "! Sform3
        sform_3    TYPE c LENGTH 30,
        "! Formtype3
        formtype_3 TYPE c LENGTH 1,
        "! Sform4
        sform_4    TYPE c LENGTH 30,
        "! Formtype4
        formtype_4 TYPE c LENGTH 1,
        "! Sform5
        sform_5    TYPE c LENGTH 30,
        "! Formtype5
        formtype_5 TYPE c LENGTH 1,
      END OF tys_z_i_tnaprtype,
      "! <p class="shorttext synchronized">List of Z_I_TNAPRType</p>
      tyt_z_i_tnaprtype TYPE STANDARD TABLE OF tys_z_i_tnaprtype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_NAST
        "! <br/> Collection of type 'Z_I_NASTType'
        z_i_nast                   TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_NAST',
        "! Z_I_TNAPR
        "! <br/> Collection of type 'Z_I_TNAPRType'
        z_i_tnapr                  TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_TNAPR',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_NASTType</p>
        "! See also structure type {@link ..tys_z_i_nasttype}
        BEGIN OF z_i_nasttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_nasttype,
        "! <p class="shorttext synchronized">Internal names for Z_I_TNAPRType</p>
        "! See also structure type {@link ..tys_z_i_tnaprtype}
        BEGIN OF z_i_tnaprtype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_tnaprtype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_NASTType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_nasttype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_TNAPRType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_tnaprtype RAISING /iwbep/cx_gateway.

ENDCLASS.



CLASS ZSCM_ZVTS_PO_PDF IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_zvts_po_pdf' ) ##NO_TEXT.
  ...
  METHOD def_z_i_nasttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_NASTTYPE'
                                    is_structure              = VALUE tys_z_i_nasttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_NASTType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_NAST' ).
    lo_entity_set->set_edm_name( 'Z_I_NAST' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJKY' ).
    lo_primitive_property->set_edm_name( 'Objky' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ERUHR' ).
    lo_primitive_property->set_edm_name( 'Eruhr' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'NACHA' ).
    lo_primitive_property->set_edm_name( 'Nacha' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ANZAL' ).
    lo_primitive_property->set_edm_name( 'Anzal' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VSZTP' ).
    lo_primitive_property->set_edm_name( 'Vsztp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VSDAT' ).
    lo_primitive_property->set_edm_name( 'Vsdat' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VSURA' ).
    lo_primitive_property->set_edm_name( 'Vsura' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'Time' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VSURB' ).
    lo_primitive_property->set_edm_name( 'Vsurb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'Time' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MANUE' ).
    lo_primitive_property->set_edm_name( 'Manue' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DATVR' ).
    lo_primitive_property->set_edm_name( 'Datvr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UHRVR' ).
    lo_primitive_property->set_edm_name( 'Uhrvr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'Time' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DATRE' ).
    lo_primitive_property->set_edm_name( 'Datre' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'VSTAT' ).
    lo_primitive_property->set_edm_name( 'Vstat' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'AKTIV' ).
    lo_primitive_property->set_edm_name( 'Aktiv' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DSNAM' ).
    lo_primitive_property->set_edm_name( 'Dsnam' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DSUF_1' ).
    lo_primitive_property->set_edm_name( 'Dsuf1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DSUF_2' ).
    lo_primitive_property->set_edm_name( 'Dsuf2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DIMME' ).
    lo_primitive_property->set_edm_name( 'Dimme' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DELET' ).
    lo_primitive_property->set_edm_name( 'Delet' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'AENDE' ).
    lo_primitive_property->set_edm_name( 'Aende' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REPET' ).
    lo_primitive_property->set_edm_name( 'Repet' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REPID' ).
    lo_primitive_property->set_edm_name( 'Repid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 8 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PFLD_1' ).
    lo_primitive_property->set_edm_name( 'Pfld1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PFLD_2' ).
    lo_primitive_property->set_edm_name( 'Pfld2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PFLD_3' ).
    lo_primitive_property->set_edm_name( 'Pfld3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PFLD_4' ).
    lo_primitive_property->set_edm_name( 'Pfld4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PFLD_5' ).
    lo_primitive_property->set_edm_name( 'Pfld5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PMID_1' ).
    lo_primitive_property->set_edm_name( 'Pmid1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PMID_2' ).
    lo_primitive_property->set_edm_name( 'Pmid2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PMID_3' ).
    lo_primitive_property->set_edm_name( 'Pmid3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PMID_4' ).
    lo_primitive_property->set_edm_name( 'Pmid4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PMID_5' ).
    lo_primitive_property->set_edm_name( 'Pmid5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDIKEY' ).
    lo_primitive_property->set_edm_name( 'Edikey' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 8 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDITRANS' ).
    lo_primitive_property->set_edm_name( 'Editrans' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SNDDR' ).
    lo_primitive_property->set_edm_name( 'Snddr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SNDEX' ).
    lo_primitive_property->set_edm_name( 'Sndex' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SNDCP' ).
    lo_primitive_property->set_edm_name( 'Sndcp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SNDBC' ).
    lo_primitive_property->set_edm_name( 'Sndbc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FORFB' ).
    lo_primitive_property->set_edm_name( 'Forfb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRIFB' ).
    lo_primitive_property->set_edm_name( 'Prifb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ACALL' ).
    lo_primitive_property->set_edm_name( 'Acall' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJAC' ).
    lo_primitive_property->set_edm_name( 'Objac' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJRR' ).
    lo_primitive_property->set_edm_name( 'Objrr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJRN' ).
    lo_primitive_property->set_edm_name( 'Objrn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OUTFL' ).
    lo_primitive_property->set_edm_name( 'Outfl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJSNS' ).
    lo_primitive_property->set_edm_name( 'Objsns' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJPRI' ).
    lo_primitive_property->set_edm_name( 'Objpri' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OBJCP' ).
    lo_primitive_property->set_edm_name( 'Objcp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'NAUTO' ).
    lo_primitive_property->set_edm_name( 'Nauto' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDRECEIVER' ).
    lo_primitive_property->set_edm_name( 'Tdreceiver' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDDIVISION' ).
    lo_primitive_property->set_edm_name( 'Tddivision' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDOCOVER' ).
    lo_primitive_property->set_edm_name( 'Tdocover' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDCOVTITLE' ).
    lo_primitive_property->set_edm_name( 'Tdcovtitle' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 68 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDAUTORITY' ).
    lo_primitive_property->set_edm_name( 'Tdautority' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDARMOD' ).
    lo_primitive_property->set_edm_name( 'Tdarmod' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OPTARCNR' ).
    lo_primitive_property->set_edm_name( 'Optarcnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CMFPNR' ).
    lo_primitive_property->set_edm_name( 'Cmfpnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'USRNAM' ).
    lo_primitive_property->set_edm_name( 'Usrnam' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'EVENT' ).
    lo_primitive_property->set_edm_name( 'Event' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SORT_3' ).
    lo_primitive_property->set_edm_name( 'Sort3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'TDSCHEDULE' ).
    lo_primitive_property->set_edm_name( 'Tdschedule' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TLAND' ).
    lo_primitive_property->set_edm_name( 'Tland' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_tnaprtype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_TNAPRTYPE'
                                    is_structure              = VALUE tys_z_i_tnaprtype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_TNAPRType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_TNAPR' ).
    lo_entity_set->set_edm_name( 'Z_I_TNAPR' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PGNAM' ).
    lo_primitive_property->set_edm_name( 'Pgnam' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RONAM' ).
    lo_primitive_property->set_edm_name( 'Ronam' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FONAM' ).
    lo_primitive_property->set_edm_name( 'Fonam' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PGNAM_2' ).
    lo_primitive_property->set_edm_name( 'Pgnam2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RONAM_2' ).
    lo_primitive_property->set_edm_name( 'Ronam2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FONAM_2' ).
    lo_primitive_property->set_edm_name( 'Fonam2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PGNAM_3' ).
    lo_primitive_property->set_edm_name( 'Pgnam3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RONAM_3' ).
    lo_primitive_property->set_edm_name( 'Ronam3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FONAM_3' ).
    lo_primitive_property->set_edm_name( 'Fonam3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PGNAM_4' ).
    lo_primitive_property->set_edm_name( 'Pgnam4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RONAM_4' ).
    lo_primitive_property->set_edm_name( 'Ronam4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FONAM_4' ).
    lo_primitive_property->set_edm_name( 'Fonam4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PGNAM_5' ).
    lo_primitive_property->set_edm_name( 'Pgnam5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RONAM_5' ).
    lo_primitive_property->set_edm_name( 'Ronam5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FONAM_5' ).
    lo_primitive_property->set_edm_name( 'Fonam5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FUNCNAME' ).
    lo_primitive_property->set_edm_name( 'Funcname' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SFORM' ).
    lo_primitive_property->set_edm_name( 'Sform' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FORMTYPE' ).
    lo_primitive_property->set_edm_name( 'Formtype' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SFORM_2' ).
    lo_primitive_property->set_edm_name( 'Sform2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FORMTYPE_2' ).
    lo_primitive_property->set_edm_name( 'Formtype2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SFORM_3' ).
    lo_primitive_property->set_edm_name( 'Sform3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FORMTYPE_3' ).
    lo_primitive_property->set_edm_name( 'Formtype3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SFORM_4' ).
    lo_primitive_property->set_edm_name( 'Sform4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FORMTYPE_4' ).
    lo_primitive_property->set_edm_name( 'Formtype4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SFORM_5' ).
    lo_primitive_property->set_edm_name( 'Sform5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FORMTYPE_5' ).
    lo_primitive_property->set_edm_name( 'Formtype5' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
