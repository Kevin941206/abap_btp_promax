...
"! <em>cds_zsd_po_deliv_address</em>
CLASS zscm_po_deliv_address DEFINITION
  PUBLIC
...
CLASS ZSCM_PO_DELIV_ADDRESS IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_po_deliv_address' ) ##NO_TEXT.
