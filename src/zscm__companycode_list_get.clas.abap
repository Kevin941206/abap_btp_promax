...
"! <em>cds_zsd_companycode_list_get</em>
CLASS zscm__companycode_list_get DEFINITION
  PUBLIC
...
CLASS ZSCM__COMPANYCODE_LIST_GET IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_companycode_list_get' ) ##NO_TEXT.
