...
CLASS zscm_usr21 DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_USR21Type</p>
      BEGIN OF tys_z_i_usr_21_type,
        ...
        "! Kostl
        kostl            TYPE c LENGTH 8,
        "! StartMenu
        start_menu       TYPE c LENGTH 30,
        "! Idadtype
        idadtype         TYPE c LENGTH 2,
        "! Bpperson
        bpperson         TYPE sysuuid_x16,
        "! Organization
        organization     TYPE sysuuid_x16,
        "! Responsible
        responsible      TYPE c LENGTH 12,
        "! Techdesc
        techdesc         TYPE c LENGTH 80,
        "! IdentityGuid
        identity_guid    TYPE sysuuid_x16,
        "! TemplateOrgtype
        template_orgtype TYPE c LENGTH 1,
        "! TemplateOrgaddr
        template_orgaddr TYPE c LENGTH 10,
      END OF tys_z_i_usr_21_type,
      "! <p class="shorttext synchronized">List of Z_I_USR21Type</p>
      tyt_z_i_usr_21_type TYPE STANDARD TABLE OF tys_z_i_usr_21_type WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_USR21
        "! <br/> Collection of type 'Z_I_USR21Type'
        z_i_usr_21                 TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_USR_21',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_USR21Type</p>
        "! See also structure type {@link ..tys_z_i_usr_21_type}
        BEGIN OF z_i_usr_21_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_usr_21_type,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_USR21Type</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_usr_21_type RAISING /iwbep/cx_gateway.

ENDCLASS.


CLASS zscm_usr21 IMPLEMENTATION.

  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_usr21' ) ##NO_TEXT.
  ...
  METHOD def_z_i_usr_21_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_USR_21_TYPE'
                                    is_structure              = VALUE tys_z_i_usr_21_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_USR21Type' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_USR_21' ).
    lo_entity_set->set_edm_name( 'Z_I_USR21' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'START_MENU' ).
    lo_primitive_property->set_edm_name( 'StartMenu' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IDADTYPE' ).
    lo_primitive_property->set_edm_name( 'Idadtype' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BPPERSON' ).
    lo_primitive_property->set_edm_name( 'Bpperson' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ORGANIZATION' ).
    lo_primitive_property->set_edm_name( 'Organization' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RESPONSIBLE' ).
    lo_primitive_property->set_edm_name( 'Responsible' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TECHDESC' ).
    lo_primitive_property->set_edm_name( 'Techdesc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 80 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IDENTITY_GUID' ).
    lo_primitive_property->set_edm_name( 'IdentityGuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TEMPLATE_ORGTYPE' ).
    lo_primitive_property->set_edm_name( 'TemplateOrgtype' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TEMPLATE_ORGADDR' ).
    lo_primitive_property->set_edm_name( 'TemplateOrgaddr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
