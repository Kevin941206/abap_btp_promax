...
"! <em>cds_zsd_adrc_2</em>
CLASS zscm_adrc_2 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">z_i_adrc_2Type</p>
      BEGIN OF tys_z_i_adrc_2_type,
      ...
      END OF tys_z_i_adrc_2_type,
      "! <p class="shorttext synchronized">List of z_i_adrc_2Type</p>
      tyt_z_i_adrc_2_type TYPE STANDARD TABLE OF tys_z_i_adrc_2_type WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! z_i_adrc_2
        "! <br/> Collection of type 'z_i_adrc_2Type'
        z_i_adrc_2                 TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_ADRC_2',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for z_i_adrc_2Type</p>
        "! See also structure type {@link ..tys_z_i_adrc_2_type}
        BEGIN OF z_i_adrc_2_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_adrc_2_type,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define z_i_adrc_2Type</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_adrc_2_type RAISING /iwbep/cx_gateway.

ENDCLASS.



CLASS ZSCM_ADRC_2 IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_adrc_2' ) ##NO_TEXT.
  ...
  METHOD def_z_i_adrc_2_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_ADRC_2_TYPE'
                                    is_structure              = VALUE tys_z_i_adrc_2_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'z_i_adrc_2Type' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_ADRC_2' ).
    lo_entity_set->set_edm_name( 'z_i_adrc_2' ) ##NO_TEXT.
