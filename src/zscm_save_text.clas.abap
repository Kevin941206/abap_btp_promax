...
"! <em>ZFM_SAVE_TEXT_SRV</em>
CLASS zscm_save_text DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      BEGIN OF tys_header,
        ...
        "! Savemode
        savemode  TYPE c LENGTH 1,
        "! Owner
        owner     TYPE c LENGTH 1,
        "! Subrc
...
CLASS zscm_save_text IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'ZFM_SAVE_TEXT_SRV' ) ##NO_TEXT.
  ...
  METHOD def_header.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SAVEMODE' ).
    lo_primitive_property->set_edm_name( 'Savemode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OWNER' ).
    lo_primitive_property->set_edm_name( 'Owner' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
