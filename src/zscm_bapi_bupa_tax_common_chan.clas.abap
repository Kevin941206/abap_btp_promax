...
"! <em>ZFM_BAPI_BUPA_TAX_COMMON_CHANG_SRV</em>
CLASS zscm_bapi_bupa_tax_common_chan DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      BEGIN OF tys_header,
        ...
        "! NaturalPerson
        natural_person TYPE c LENGTH 1,
      END OF tys_header,
...
CLASS zscm_bapi_bupa_tax_common_chan IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'ZFM_BAPI_BUPA_TAX_COMMON_CHANG_SRV' ) ##NO_TEXT.
  ...
  METHOD def_header.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'NATURAL_PERSON' ).
    lo_primitive_property->set_edm_name( 'NaturalPerson' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
