...
"! <em>cds_zsd_product</em>
CLASS zscm_product DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_PRODUCTType</p>
      BEGIN OF tys_z_i_producttype,
        "! <em>Key property</em> Product
        product                    TYPE c LENGTH 18,
        "! ProductExternalID
        product_external_id        TYPE c LENGTH 40,
        "! ProductOID
        product_oid                TYPE c LENGTH 128,
        "! ProductType
        ...
        "! ProductCategory
        product_category           TYPE c LENGTH 2,
        "! Brand
        ...
        prod_no_in_gen_prod_in_pre TYPE c LENGTH 18,
        ...
        "! HasEmptiesBOM
        has_empties_bom            TYPE abap_bool,
        ...
        product_valid_start_date   TYPE datn,
        "! ArticleCategory
        article_category           TYPE c LENGTH 2,
        "! ContentUnit
        content_unit               TYPE c LENGTH 3,
        "! NetContent
        net_content                TYPE p LENGTH 7 DECIMALS 3,
        "! ComparisonPriceQuantity
        comparison_price_quantity  TYPE p LENGTH 3 DECIMALS 0,
        "! GrossContent
        gross_content              TYPE p LENGTH 7 DECIMALS 3,
        "! ProductValidEndDate
        product_valid_end_date     TYPE datn,
        "! AssortmentListType
        assortment_list_type       TYPE c LENGTH 1,
        "! HasTextilePartsWthAnimalOrigin
        has_textile_parts_wth_anim TYPE abap_bool,
        "! ProductSeasonUsageCategory
        product_season_usage_categ TYPE c LENGTH 1,
        "! IndustrySector
        ...
        prod_sup_chn_mgmt_uuid_22  TYPE c LENGTH 40,
        ...
        own_inventory_managed_prod TYPE c LENGTH 18,
        ...
        global_trade_item_number_v TYPE c LENGTH 2,
        ...
        "! ProductIsLocked
        product_is_locked          TYPE abap_bool,
        "! DiscountInKindEligibility
        discount_in_kind_eligibili TYPE c LENGTH 1,
        "! SmartFormName
        smart_form_name            TYPE c LENGTH 30,
        "! PackingReferenceProduct
        packing_reference_product  TYPE c LENGTH 18,
        "! BasicMaterial
        basic_material             TYPE c LENGTH 48,
        ...
        segmentation_strategy      TYPE c LENGTH 8,
        "! SegmentationIsRelevant
        segmentation_is_relevant   TYPE c LENGTH 1,
        "! IsChemicalComplianceRelevant
        is_chemical_compliance_rel TYPE c LENGTH 1,
        "! ManufacturerBookPartNumber
        manufacturer_book_part_num TYPE c LENGTH 18,
        "! LogisticalProductCategory
        logistical_product_categor TYPE c LENGTH 1,
        "! SalesProduct
        sales_product              TYPE c LENGTH 18,
        "! ProdCharc1InternalNumber
        prod_charc_1_internal_numb TYPE c LENGTH 10,
        "! ProdCharc2InternalNumber
        prod_charc_2_internal_numb TYPE c LENGTH 10,
        "! ProdCharc3InternalNumber
        prod_charc_3_internal_numb TYPE c LENGTH 10,
        ...
        dfs_ammunition_group_code  TYPE c LENGTH 8,
        "! DfsRICIdentifier
        dfs_ricidentifier          TYPE int8,
        "! DfsProductSensitivity
        dfs_product_sensitivity    TYPE c LENGTH 4,
        "! DfsManufacturerPartLongNumber
        dfs_manufacturer_part_long TYPE c LENGTH 60,
        "! DfsMatlConditionMgmt
        dfs_matl_condition_mgmt    TYPE c LENGTH 1,
        "! DfsReturnDelivery
        dfs_return_delivery        TYPE c LENGTH 1,
        "! DfsLogisticsLevel
        dfs_logistics_level        TYPE c LENGTH 1,
        "! DfsNationalItemIdnNumber
        dfs_national_item_idn_numb TYPE c LENGTH 9,
        "! odata.etag
        etag                       TYPE string,
      END OF tys_z_i_producttype,
      "! <p class="shorttext synchronized">List of Z_I_PRODUCTType</p>
      tyt_z_i_producttype TYPE STANDARD TABLE OF tys_z_i_producttype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_PRODUCT
        "! <br/> Collection of type 'Z_I_PRODUCTType'
        z_i_product                TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_PRODUCT',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_PRODUCTType</p>
        "! See also structure type {@link ..tys_z_i_producttype}
        BEGIN OF z_i_producttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_producttype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_PRODUCTType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_producttype RAISING /iwbep/cx_gateway.

ENDCLASS.



CLASS ZSCM_PRODUCT IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_product' ) ##NO_TEXT.
  ...
  METHOD def_z_i_producttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_PRODUCTTYPE'
                                    is_structure              = VALUE tys_z_i_producttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_PRODUCTType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_PRODUCT' ).
    lo_entity_set->set_edm_name( 'Z_I_PRODUCT' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRODUCT_EXTERNAL_ID' ).
    lo_primitive_property->set_edm_name( 'ProductExternalID' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRODUCT_OID' ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'HAS_EMPTIES_BOM' ).
    lo_primitive_property->set_edm_name( 'HasEmptiesBOM' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRODUCT_VALID_START_DATE' ).
    lo_primitive_property->set_edm_name( 'ProductValidStartDate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'CONTENT_UNIT' ).
    lo_primitive_property->set_edm_name( 'ContentUnit' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'NET_CONTENT' ).
    lo_primitive_property->set_edm_name( 'NetContent' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 13 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'COMPARISON_PRICE_QUANTITY' ).
    lo_primitive_property->set_edm_name( 'ComparisonPriceQuantity' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GROSS_CONTENT' ).
    lo_primitive_property->set_edm_name( 'GrossContent' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 13 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRODUCT_VALID_END_DATE' ).
    lo_primitive_property->set_edm_name( 'ProductValidEndDate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ASSORTMENT_LIST_TYPE' ).
    lo_primitive_property->set_edm_name( 'AssortmentListType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'HAS_TEXTILE_PARTS_WTH_ANIM' ).
    lo_primitive_property->set_edm_name( 'HasTextilePartsWthAnimalOrigin' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRODUCT_SEASON_USAGE_CATEG' ).
    lo_primitive_property->set_edm_name( 'ProductSeasonUsageCategory' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROD_SUP_CHN_MGMT_UUID_22' ).
    lo_primitive_property->set_edm_name( 'ProdSupChnMgmtUUID22' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'GLOBAL_TRADE_ITEM_NUMBER_V' ).
    lo_primitive_property->set_edm_name( 'GlobalTradeItemNumberVariant' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PRODUCT_IS_LOCKED' ).
    lo_primitive_property->set_edm_name( 'ProductIsLocked' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SMART_FORM_NAME' ).
    lo_primitive_property->set_edm_name( 'SmartFormName' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'BASIC_MATERIAL' ).
    lo_primitive_property->set_edm_name( 'BasicMaterial' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SEGMENTATION_STRATEGY' ).
    lo_primitive_property->set_edm_name( 'SegmentationStrategy' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 8 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SEGMENTATION_IS_RELEVANT' ).
    lo_primitive_property->set_edm_name( 'SegmentationIsRelevant' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IS_CHEMICAL_COMPLIANCE_REL' ).
    lo_primitive_property->set_edm_name( 'IsChemicalComplianceRelevant' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MANUFACTURER_BOOK_PART_NUM' ).
    lo_primitive_property->set_edm_name( 'ManufacturerBookPartNumber' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'LOGISTICAL_PRODUCT_CATEGOR' ).
    lo_primitive_property->set_edm_name( 'LogisticalProductCategory' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SALES_PRODUCT' ).
    lo_primitive_property->set_edm_name( 'SalesProduct' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROD_CHARC_1_INTERNAL_NUMB' ).
    lo_primitive_property->set_edm_name( 'ProdCharc1InternalNumber' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROD_CHARC_2_INTERNAL_NUMB' ).
    lo_primitive_property->set_edm_name( 'ProdCharc2InternalNumber' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROD_CHARC_3_INTERNAL_NUMB' ).
    lo_primitive_property->set_edm_name( 'ProdCharc3InternalNumber' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_AMMUNITION_GROUP_CODE' ).
    lo_primitive_property->set_edm_name( 'DfsAmmunitionGroupCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 8 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_RICIDENTIFIER' ).
    lo_primitive_property->set_edm_name( 'DfsRICIdentifier' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Int64' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_PRODUCT_SENSITIVITY' ).
    lo_primitive_property->set_edm_name( 'DfsProductSensitivity' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_MANUFACTURER_PART_LONG' ).
    lo_primitive_property->set_edm_name( 'DfsManufacturerPartLongNumber' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 60 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_MATL_CONDITION_MGMT' ).
    lo_primitive_property->set_edm_name( 'DfsMatlConditionMgmt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_RETURN_DELIVERY' ).
    lo_primitive_property->set_edm_name( 'DfsReturnDelivery' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_LOGISTICS_LEVEL' ).
    lo_primitive_property->set_edm_name( 'DfsLogisticsLevel' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DFS_NATIONAL_ITEM_IDN_NUMB' ).
    lo_primitive_property->set_edm_name( 'DfsNationalItemIdnNumber' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 9 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
