...
CLASS zscm_t007s DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_T007SType</p>
      BEGIN OF tys_z_i_t_007_stype,
        "! <em>Key property</em> Spras
        spras  TYPE c LENGTH 2,
        "! <em>Key property</em> Kalsm
        kalsm  TYPE c LENGTH 6,
        "! <em>Key property</em> Mwskz
        mwskz  TYPE c LENGTH 2,
        "! Text1
        text_1 TYPE c LENGTH 50,
        "! odata.etag
        etag   TYPE string,
      END OF tys_z_i_t_007_stype,
      "! <p class="shorttext synchronized">List of Z_I_T007SType</p>
      tyt_z_i_t_007_stype TYPE STANDARD TABLE OF tys_z_i_t_007_stype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_T007S
        "! <br/> Collection of type 'Z_I_T007SType'
        z_i_t_007_s                TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_T_007_S',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_T007SType</p>
        "! See also structure type {@link ..tys_z_i_t_007_stype}
        BEGIN OF z_i_t_007_stype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_t_007_stype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_T007SType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_t_007_stype RAISING /iwbep/cx_gateway.

ENDCLASS.



CLASS ZSCM_T007S IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_t007s' ) ##NO_TEXT.
  ...
  METHOD def_z_i_t_007_stype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_T_007_STYPE'
                                    is_structure              = VALUE tys_z_i_t_007_stype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_T007SType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_T_007_S' ).
    lo_entity_set->set_edm_name( 'Z_I_T007S' ) ##NO_TEXT.
