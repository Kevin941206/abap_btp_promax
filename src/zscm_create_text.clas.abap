...
"! <em>ZFM_CREATE_TEXT_SRV</em>
CLASS zscm_create_text DEFINITION
  PUBLIC
...
CLASS ZSCM_CREATE_TEXT IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'ZFM_CREATE_TEXT_SRV' ) ##NO_TEXT.
  ...
  METHOD def_header.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SAVE' ).
    lo_primitive_property->set_edm_name( 'Save' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
