...
"! <em>cds_zsd_zfiglmx_crp_journal_detail</em>
CLASS zscm_zfiglmx_journal_detail DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_AIF_T_MVMApvalType</p>
      BEGIN OF tys_z_i_aif_t_mvmapval_type,
        "! <em>Key property</em> Ns
        ns              TYPE c LENGTH 6,
        "! <em>Key property</em> Vmapname
        vmapname        TYPE c LENGTH 20,
        "! <em>Key property</em> Vmapvalnr
        vmapvalnr       TYPE c LENGTH 5,
        "! ExtValue
        ext_value       TYPE c LENGTH 200,
        "! IntValue
        int_value       TYPE c LENGTH 200,
        "! DefaultFlag
        default_flag    TYPE abap_bool,
        "! SendingSystem
        sending_system  TYPE c LENGTH 60,
        "! GroupId
        group_id        TYPE c LENGTH 32,
        "! ValidPeriodNo
        valid_period_no TYPE c LENGTH 10,
        "! ValidFrom
        valid_from      TYPE datn,
        "! ValidTo
        valid_to        TYPE datn,
      END OF tys_z_i_aif_t_mvmapval_type,
      "! <p class="shorttext synchronized">List of Z_I_AIF_T_MVMApvalType</p>
      tyt_z_i_aif_t_mvmapval_type TYPE STANDARD TABLE OF tys_z_i_aif_t_mvmapval_type WITH DEFAULT KEY.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_BSE_CLRType</p>
      BEGIN OF tys_z_i_bse_clrtype,
        "! <em>Key property</em> BukrsClr
        bukrs_clr TYPE c LENGTH 4,
        "! <em>Key property</em> BelnrClr
        belnr_clr TYPE c LENGTH 10,
        "! <em>Key property</em> GjahrClr
        gjahr_clr TYPE c LENGTH 4,
        "! <em>Key property</em> IndexClr
        index_clr TYPE c LENGTH 6,
        "! Agzei
        agzei     TYPE p LENGTH 3 DECIMALS 0,
        "! Agbuz
        agbuz     TYPE c LENGTH 3,
        "! Waers
        waers     TYPE c LENGTH 5,
        "! Clrin
        clrin     TYPE c LENGTH 1,
        "! Bukrs
        bukrs     TYPE c LENGTH 4,
        "! Belnr
        belnr     TYPE c LENGTH 10,
        ...
        "! Difhw
        difhw     TYPE p LENGTH 8 DECIMALS 3,
        "! Difh2
        difh_2    TYPE p LENGTH 8 DECIMALS 3,
        "! Difh3
        difh_3    TYPE p LENGTH 8 DECIMALS 3,
        "! Diffw
        diffw     TYPE p LENGTH 8 DECIMALS 3,
        "! Sknto
        ...
        "! Rdiff
        rdiff     TYPE p LENGTH 8 DECIMALS 3,
        "! Rdif2
        rdif_2    TYPE p LENGTH 8 DECIMALS 3,
        "! Rdif3
        rdif_3    TYPE p LENGTH 8 DECIMALS 3,
        "! Koart
        koart     TYPE c LENGTH 1,
        "! Umskz
        umskz     TYPE c LENGTH 1,
        ...
        "! WaersOp
        waers_op  TYPE c LENGTH 5,
        "! WsktoOp
        wskto_op  TYPE p LENGTH 8 DECIMALS 3,
        "! Uzawe
        uzawe     TYPE c LENGTH 2,
        "! Dataaging
        dataaging TYPE datn,
      END OF tys_z_i_bse_clrtype,
      "! <p class="shorttext synchronized">List of Z_I_BSE_CLRType</p>
      tyt_z_i_bse_clrtype TYPE STANDARD TABLE OF tys_z_i_bse_clrtype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_BUT051Type</p>
      BEGIN OF tys_z_i_but_051_type,
        "! <em>Key property</em> Relnr
        relnr             TYPE c LENGTH 12,
        "! <em>Key property</em> Partner1
        partner_1         TYPE c LENGTH 10,
        "! <em>Key property</em> Partner2
        partner_2         TYPE c LENGTH 10,
        "! <em>Key property</em> DateTo
        date_to           TYPE datn,
        "! Reltyp
        ...
        xrf               TYPE abap_bool,
        "! Fnctn
        fnctn             TYPE c LENGTH 40,
        "! Pafkt
        pafkt             TYPE c LENGTH 4,
        "! Dprtmnt
        dprtmnt           TYPE c LENGTH 40,
        "! Abtnr
        abtnr             TYPE c LENGTH 4,
        "! Paauth
        paauth            TYPE c LENGTH 1,
        "! Pavip
        pavip             TYPE c LENGTH 1,
        "! Parem
        parem             TYPE c LENGTH 40,
        "! TelNumber
        tel_number        TYPE c LENGTH 30,
        "! TelExtens
        tel_extens        TYPE c LENGTH 10,
        ...
        fax_extens        TYPE c LENGTH 10,
        "! SmtpAddress
        smtp_address      TYPE c LENGTH 241,
        "! RelPer
        rel_per           TYPE p LENGTH 6 DECIMALS 7,
        "! RelAmo
        rel_amo           TYPE p LENGTH 8 DECIMALS 3,
        "! RelCur
        rel_cur           TYPE c LENGTH 5,
        "! CallRuleid
        call_ruleid       TYPE c LENGTH 25,
        "! VisitRuleid
        visit_ruleid      TYPE c LENGTH 25,
        "! CallGuid
        call_guid         TYPE sysuuid_x16,
        "! VisitGuid
        visit_guid        TYPE sysuuid_x16,
        "! BpEewBut051
        bp_eew_but_051    TYPE c LENGTH 1,
        "! BpEewBut051Sp
        bp_eew_but_051_sp TYPE c LENGTH 1,
      END OF tys_z_i_but_051_type,
      "! <p class="shorttext synchronized">List of Z_I_BUT051Type</p>
      tyt_z_i_but_051_type TYPE STANDARD TABLE OF tys_z_i_but_051_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_DFKKBPTAXNUMType</p>
      BEGIN OF tys_z_i_dfkkbptaxnumtype,
        "! <em>Key property</em> Partner
        partner  TYPE c LENGTH 10,
        "! <em>Key property</em> Taxtype
        taxtype  TYPE c LENGTH 4,
        "! Taxnum
        taxnum   TYPE c LENGTH 20,
        "! Taxnumxl
        taxnumxl TYPE c LENGTH 60,
      END OF tys_z_i_dfkkbptaxnumtype,
      "! <p class="shorttext synchronized">List of Z_I_DFKKBPTAXNUMType</p>
      tyt_z_i_dfkkbptaxnumtype TYPE STANDARD TABLE OF tys_z_i_dfkkbptaxnumtype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_EDOCUMENTType</p>
      BEGIN OF tys_z_i_edocumenttype,
        "! <em>Key property</em> EdocGuid
        edoc_guid             TYPE sysuuid_x16,
        "! SeqNo
        seq_no                TYPE c LENGTH 3,
        "! Bukrs
        bukrs                 TYPE c LENGTH 4,
        "! Land
        ...
        "! ProcStatus
        proc_status           TYPE c LENGTH 10,
        "! Logsys
        logsys                TYPE c LENGTH 10,
        "! ChangedBy
        changed_by            TYPE c LENGTH 12,
        "! ChangeDate
        change_date           TYPE datn,
        "! ChangeTime
        change_time           TYPE timn,
        "! CreatedBy
        created_by            TYPE c LENGTH 12,
        "! CreateDate
        create_date           TYPE datn,
        "! CreateTime
        create_time           TYPE timn,
        "! SourceCreatedBy
        source_created_by     TYPE c LENGTH 12,
        "! Process
        process               TYPE c LENGTH 10,
        "! LastProcstep
        last_procstep         TYPE c LENGTH 10,
        "! LastProcstepVariant
        last_procstep_variant TYPE c LENGTH 10,
        "! ErrorFlag
        error_flag            TYPE abap_bool,
        "! ProcessVersion
        process_version       TYPE c LENGTH 4,
        "! DocrefSeqnr
        docref_seqnr          TYPE c LENGTH 5,
        "! Status
        ...
        "! Metastatus
        metastatus            TYPE c LENGTH 4,
        "! RefProcess
        ref_process           TYPE c LENGTH 10,
        "! EdocumentClass
        edocument_class       TYPE c LENGTH 30,
        "! ArchivePrep
        archive_prep          TYPE abap_bool,
        "! InterfaceType
        interface_type        TYPE c LENGTH 10,
        "! ApprovalId
        approval_id           TYPE string,
        "! InterfaceGuid
        interface_guid        TYPE sysuuid_x16,
        "! FileGuid
        file_guid             TYPE sysuuid_x16,
        "! ResponseCode
        response_code         TYPE string,
        "! InterfaceId
        interface_id          TYPE c LENGTH 30,
        "! IntVersion
        int_version           TYPE c LENGTH 4,
        "! CountArchive
        count_archive         TYPE abap_bool,
      END OF tys_z_i_edocumenttype,
      "! <p class="shorttext synchronized">List of Z_I_EDOCUMENTType</p>
      tyt_z_i_edocumenttype TYPE STANDARD TABLE OF tys_z_i_edocumenttype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_EDOMXINVOICEType</p>
      BEGIN OF tys_z_i_edomxinvoicetype,
        "! <em>Key property</em> EdocGuid
        edoc_guid       TYPE sysuuid_x16,
        "! DocNumPrefix
        doc_num_prefix  TYPE c LENGTH 5,
        "! DocNum
        doc_num         TYPE c LENGTH 10,
        "! Uuid
        uuid            TYPE c LENGTH 36,
        "! Timestamp
        timestamp       TYPE c LENGTH 19,
        "! TaxIdOfPac
        tax_id_of_pac   TYPE c LENGTH 16,
        "! DigestValue
        digest_value    TYPE string,
        "! TransId
        trans_id        TYPE string,
        "! Canclreasncode
        canclreasncode  TYPE c LENGTH 2,
        "! SubstituteUuid
        substitute_uuid TYPE c LENGTH 36,
      END OF tys_z_i_edomxinvoicetype,
      "! <p class="shorttext synchronized">List of Z_I_EDOMXINVOICEType</p>
      tyt_z_i_edomxinvoicetype TYPE STANDARD TABLE OF tys_z_i_edomxinvoicetype WITH DEFAULT KEY.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_REGUHType</p>
      BEGIN OF tys_z_i_reguhtype,
        "! <em>Key property</em> Laufd
        laufd           TYPE datn,
        "! <em>Key property</em> Laufi
        laufi           TYPE c LENGTH 6,
        "! <em>Key property</em> Xvorl
        xvorl           TYPE abap_bool,
        "! <em>Key property</em> Zbukr
        zbukr           TYPE c LENGTH 4,
        "! <em>Key property</em> Lifnr
        lifnr           TYPE c LENGTH 10,
        "! <em>Key property</em> Kunnr
        kunnr           TYPE c LENGTH 10,
        "! <em>Key property</em> Empfg
        empfg           TYPE c LENGTH 16,
        "! <em>Key property</em> Vblnr
        vblnr           TYPE c LENGTH 10,
        "! Avisg
        avisg           TYPE c LENGTH 1,
        "! Waers
        waers           TYPE c LENGTH 5,
        "! Srtgb
        srtgb           TYPE c LENGTH 4,
        "! Anred
        anred           TYPE c LENGTH 15,
        "! Name1
        name_1          TYPE c LENGTH 35,
        ...
        stcd_1          TYPE c LENGTH 16,
        "! Wevwv
        wevwv           TYPE c LENGTH 1,
        "! Zanre
        zanre           TYPE c LENGTH 15,
        "! Znme1
        znme_1          TYPE c LENGTH 35,
        "! Znme2
        znme_2          TYPE c LENGTH 35,
        "! Znme3
        znme_3          TYPE c LENGTH 35,
        "! Znme4
        znme_4          TYPE c LENGTH 35,
        "! Zpstl
        zpstl           TYPE c LENGTH 10,
        "! Zort1
        zort_1          TYPE c LENGTH 35,
        "! Zstra
        zstra           TYPE c LENGTH 35,
        "! Zpfac
        zpfac           TYPE c LENGTH 10,
        "! Zland
        zland           TYPE c LENGTH 3,
        "! Zregi
        zregi           TYPE c LENGTH 3,
        "! Zbnks
        zbnks           TYPE c LENGTH 3,
        "! Zbnkn
        zbnkn           TYPE c LENGTH 18,
        "! ZbnknLong
        zbnkn_long      TYPE c LENGTH 35,
        "! Zbnkl
        zbnkl           TYPE c LENGTH 15,
        "! Zbkon
        zbkon           TYPE c LENGTH 2,
        "! Zbvty
        zbvty           TYPE c LENGTH 4,
        "! Zswif
        zswif           TYPE c LENGTH 11,
        "! Xezer
        xezer           TYPE abap_bool,
        "! Zspra
        zspra           TYPE c LENGTH 2,
        "! Zaldt
        zaldt           TYPE datn,
        "! Rzawe
        rzawe           TYPE c LENGTH 1,
        "! Rumsk
        rumsk           TYPE c LENGTH 1,
        "! Rzums
        rzums           TYPE c LENGTH 1,
        "! Hktid
        hktid           TYPE c LENGTH 5,
        "! Hbkid
        hbkid           TYPE c LENGTH 5,
        "! Hktiw
        hktiw           TYPE c LENGTH 5,
        "! Hbkiw
        hbkiw           TYPE c LENGTH 5,
        "! Bvtyp
        bvtyp           TYPE c LENGTH 4,
        "! Ubkon
        ubkon           TYPE c LENGTH 2,
        "! Ubknt
        ubknt           TYPE c LENGTH 18,
        "! UbkntLong
        ubknt_long      TYPE c LENGTH 35,
        "! Ubnks
        ubnks           TYPE c LENGTH 3,
        "! Ubnkl
        ubnkl           TYPE c LENGTH 15,
        "! Uiban
        uiban           TYPE c LENGTH 34,
        "! Ubhkt
        ubhkt           TYPE c LENGTH 10,
        "! Valut
        valut           TYPE datn,
        "! Crval
        crval           TYPE datn,
        ...
        wefae           TYPE datn,
        "! Rbetr
        rbetr           TYPE p LENGTH 8 DECIMALS 3,
        "! Rskon
        rskon           TYPE p LENGTH 8 DECIMALS 3,
        "! Rwbtr
        rwbtr           TYPE p LENGTH 8 DECIMALS 3,
        "! Rwskt
        rwskt           TYPE p LENGTH 8 DECIMALS 3,
        "! Rspe1
        rspe_1          TYPE p LENGTH 7 DECIMALS 3,
        "! Rspe2
        rspe_2          TYPE p LENGTH 7 DECIMALS 3,
        "! Rpost
        rpost           TYPE p LENGTH 3 DECIMALS 0,
        "! Rtext
        rtext           TYPE p LENGTH 3 DECIMALS 0,
        "! Rspm1
        rspm_1          TYPE p LENGTH 7 DECIMALS 3,
        "! Rspm2
        rspm_2          TYPE p LENGTH 7 DECIMALS 3,
        "! Wehmx
        wehmx           TYPE p LENGTH 8 DECIMALS 3,
        "! Wefmx
        wefmx           TYPE p LENGTH 8 DECIMALS 3,
        "! Wehrs
        wehrs           TYPE p LENGTH 8 DECIMALS 3,
        "! Wefrs
        wefrs           TYPE p LENGTH 8 DECIMALS 3,
        "! Weamx
        weamx           TYPE p LENGTH 2 DECIMALS 0,
        "! Busab
        ...
        "! Skvhw
        skvhw           TYPE p LENGTH 8 DECIMALS 3,
        "! Skvfw
        skvfw           TYPE p LENGTH 8 DECIMALS 3,
        "! Dskvh
        dskvh           TYPE p LENGTH 8 DECIMALS 3,
        "! Zpst2
        zpst_2          TYPE c LENGTH 10,
        "! Paygr
        paygr           TYPE c LENGTH 20,
        "! Zbnky
        zbnky           TYPE c LENGTH 15,
        "! Ubnky
        ubnky           TYPE c LENGTH 15,
        "! Pstl2
        pstl_2          TYPE c LENGTH 10,
        "! Absbu
        absbu           TYPE c LENGTH 4,
        "! Rbet2
        rbet_2          TYPE p LENGTH 8 DECIMALS 3,
        "! Rbet3
        rbet_3          TYPE p LENGTH 8 DECIMALS 3,
        "! Rsko2
        rsko_2          TYPE p LENGTH 8 DECIMALS 3,
        "! Rsko3
        rsko_3          TYPE p LENGTH 8 DECIMALS 3,
        "! Kurs2
        kurs_2          TYPE p LENGTH 5 DECIMALS 5,
        "! Kurs3f
        kurs_3_f        TYPE p LENGTH 5 DECIMALS 5,
        "! Bkref
        bkref           TYPE c LENGTH 20,
        "! Uzawe
        uzawe           TYPE c LENGTH 2,
        "! Zort2
        zort_2          TYPE c LENGTH 35,
        "! Ztlfx
        ztlfx           TYPE c LENGTH 31,
        "! Xsiwe
        xsiwe           TYPE abap_bool,
        "! Zpfor
        zpfor           TYPE c LENGTH 35,
        "! Pernr
        pernr           TYPE c LENGTH 8,
        "! Seqnr
        seqnr           TYPE c LENGTH 5,
        "! Btznr
        btznr           TYPE xstring,
        "! Ausfd
        ausfd           TYPE datn,
        ...
        augdt           TYPE datn,
        "! Ediav
        ediav           TYPE c LENGTH 1,
        "! IdocNumAvis
        idoc_num_avis   TYPE c LENGTH 16,
        "! Edibn
        edibn           TYPE c LENGTH 1,
        "! IdocNum
        idoc_num        TYPE c LENGTH 16,
        "! Ztelf
        ztelf           TYPE c LENGTH 20,
        "! Ztelx
        ztelx           TYPE c LENGTH 30,
        "! Koinh
        ...
        payt_rsn        TYPE c LENGTH 4,
        "! Zstc1
        zstc_1          TYPE c LENGTH 16,
        "! Kidno
        kidno           TYPE c LENGTH 30,
        "! Pyord
        pyord           TYPE c LENGTH 10,
        "! Regio
        regio           TYPE c LENGTH 3,
        "! Text
        text            TYPE c LENGTH 29,
        "! Btyp1
        btyp_1          TYPE c LENGTH 1,
        "! Bnks1
        bnks_1          TYPE c LENGTH 3,
        "! Bnkl1
        bnkl_1          TYPE c LENGTH 15,
        "! Bnkn1
        bnkn_1          TYPE c LENGTH 18,
        "! Bkon1
        bkon_1          TYPE c LENGTH 2,
        "! Bkrf1
        bkrf_1          TYPE c LENGTH 20,
        "! Iban1
        iban_1          TYPE c LENGTH 34,
        "! Btyp2
        btyp_2          TYPE c LENGTH 1,
        "! Bnks2
        bnks_2          TYPE c LENGTH 3,
        "! Bnkl2
        bnkl_2          TYPE c LENGTH 15,
        "! Bnkn2
        bnkn_2          TYPE c LENGTH 18,
        "! Bkon2
        bkon_2          TYPE c LENGTH 2,
        "! Bkrf2
        bkrf_2          TYPE c LENGTH 20,
        "! Iban2
        iban_2          TYPE c LENGTH 34,
        "! Btyp3
        btyp_3          TYPE c LENGTH 1,
        "! Bnks3
        bnks_3          TYPE c LENGTH 3,
        "! Bnkl3
        bnkl_3          TYPE c LENGTH 15,
        "! Bnkn3
        bnkn_3          TYPE c LENGTH 18,
        "! Bkon3
        bkon_3          TYPE c LENGTH 2,
        "! Bkrf3
        bkrf_3          TYPE c LENGTH 20,
        "! Iban3
        iban_3          TYPE c LENGTH 34,
        "! Saknr
        saknr           TYPE c LENGTH 10,
        "! Hkont
        hkont           TYPE c LENGTH 10,
        "! Alebn
        alebn           TYPE c LENGTH 1,
        "! Xkdfb
        xkdfb           TYPE abap_bool,
        "! Srtbp
        srtbp           TYPE c LENGTH 4,
        "! FpmKey
        fpm_key         TYPE c LENGTH 15,
        "! Grpno
        grpno           TYPE int4,
        "! Srtf1
        srtf_1          TYPE c LENGTH 38,
        "! Srtf2
        srtf_2          TYPE c LENGTH 56,
        "! Srtf3
        srtf_3          TYPE c LENGTH 38,
        "! Xcorr
        xcorr           TYPE abap_bool,
        "! Xavis
        xavis           TYPE abap_bool,
        "! Xcopm
        xcopm           TYPE c LENGTH 1,
        "! Dorigin
        dorigin         TYPE c LENGTH 8,
        "! Rfttrn
        rfttrn          TYPE c LENGTH 20,
        "! Zadnr
        zadnr           TYPE c LENGTH 10,
        "! Adrnr
        adrnr           TYPE c LENGTH 10,
        "! Ziban
        ziban           TYPE c LENGTH 34,
        "! Mguid
        mguid           TYPE sysuuid_x16,
        "! SeqType
        seq_type        TYPE c LENGTH 4,
        "! InstCode
        inst_code       TYPE c LENGTH 4,
        "! PurpCode
        purp_code       TYPE c LENGTH 4,
        "! Xmlst
        xmlst           TYPE c LENGTH 1,
        "! TimestampAvis
        timestamp_avis  TYPE p LENGTH 8 DECIMALS 0,
        "! Uetr
        uetr            TYPE c LENGTH 36,
        "! ZpaymentSystem
        zpayment_system TYPE c LENGTH 15,
        "! ZaliasType
        zalias_type     TYPE c LENGTH 15,
        "! ZbankAlias
        zbank_alias     TYPE c LENGTH 255,
        "! FmStatus
        fm_status       TYPE c LENGTH 1,
        "! FileNbr
        file_nbr        TYPE c LENGTH 6,
      END OF tys_z_i_reguhtype,
      "! <p class="shorttext synchronized">List of Z_I_REGUHType</p>
      tyt_z_i_reguhtype TYPE STANDARD TABLE OF tys_z_i_reguhtype WITH DEFAULT KEY.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_T001Type</p>
      BEGIN OF tys_z_i_t_001_type,
        "! Delete_mc
        ...
        "! Waabw
        waabw         TYPE c LENGTH 2,
        "! Periv
        periv         TYPE c LENGTH 2,
        "! Kokfi
        kokfi         TYPE c LENGTH 1,
        "! Rcomp
        ...
        fikrs         TYPE c LENGTH 4,
        "! Xfmco
        xfmco         TYPE abap_bool,
        "! Xfmcb
        xfmcb         TYPE abap_bool,
        "! Xfmca
        xfmca         TYPE abap_bool,
        "! Txjcd
        txjcd         TYPE c LENGTH 15,
        "! Fmhrdate
        fmhrdate      TYPE datn,
        "! Xtemplt
        xtemplt       TYPE abap_bool,
        "! TransitPlant
        transit_plant TYPE c LENGTH 4,
        "! Buvar
        buvar         TYPE c LENGTH 1,
        "! Fdbuk
        fdbuk         TYPE c LENGTH 4,
        "! Xfdis
        xfdis         TYPE abap_bool,
        "! Xvalv
        xvalv         TYPE abap_bool,
        "! Xskfn
        xskfn         TYPE abap_bool,
        "! Kkber
        kkber         TYPE c LENGTH 4,
        "! Xmwsn
        xmwsn         TYPE abap_bool,
        "! Mregl
        mregl         TYPE c LENGTH 4,
        "! Xgsbe
        xgsbe         TYPE abap_bool,
        "! Xgjrv
        xgjrv         TYPE abap_bool,
        "! Xkdft
        xkdft         TYPE abap_bool,
        "! Xprod
        xprod         TYPE abap_bool,
        "! Xeink
        xeink         TYPE abap_bool,
        "! Xjvaa
        xjvaa         TYPE abap_bool,
        "! Xvvwa
        xvvwa         TYPE abap_bool,
        "! Xslta
        xslta         TYPE abap_bool,
        "! Xfdmm
        xfdmm         TYPE abap_bool,
        "! Xfdsd
        xfdsd         TYPE abap_bool,
        "! Xextb
        xextb         TYPE abap_bool,
        "! Ebukr
        ebukr         TYPE c LENGTH 4,
        "! Ktop2
        ktop_2        TYPE c LENGTH 4,
        "! Umkrs
        umkrs         TYPE c LENGTH 4,
        "! BukrsGlob
        bukrs_glob    TYPE c LENGTH 6,
        "! Fstva
        fstva         TYPE c LENGTH 4,
        "! Opvar
        opvar         TYPE c LENGTH 4,
        "! Xcovr
        xcovr         TYPE abap_bool,
        "! Txkrs
        txkrs         TYPE c LENGTH 1,
        "! Wfvar
        wfvar         TYPE c LENGTH 4,
        "! Xbbbf
        xbbbf         TYPE abap_bool,
        "! Xbbbe
        xbbbe         TYPE abap_bool,
        "! Xbbba
        xbbba         TYPE abap_bool,
        "! Xbbko
        xbbko         TYPE abap_bool,
        "! Xstdt
        xstdt         TYPE abap_bool,
        "! Mwskv
        mwskv         TYPE c LENGTH 2,
        "! Mwska
        mwska         TYPE c LENGTH 2,
        "! Impda
        impda         TYPE c LENGTH 1,
        "! Xnegp
        xnegp         TYPE abap_bool,
        "! Xkkbi
        xkkbi         TYPE abap_bool,
        "! WtNewwt
        wt_newwt      TYPE abap_bool,
        "! PpPdate
        pp_pdate      TYPE c LENGTH 1,
        "! Infmt
        infmt         TYPE c LENGTH 4,
        "! Fstvare
        fstvare       TYPE c LENGTH 4,
        "! Kopim
        kopim         TYPE c LENGTH 1,
        "! Dkweg
        dkweg         TYPE c LENGTH 1,
        "! Offsacct
        offsacct      TYPE c LENGTH 1,
        "! Bapovar
        bapovar       TYPE c LENGTH 2,
        "! Xcos
        xcos          TYPE c LENGTH 1,
        "! Xcession
        xcession      TYPE abap_bool,
        "! Xsplt
        xsplt         TYPE abap_bool,
        "! Surccm
        surccm        TYPE c LENGTH 1,
        "! Dtprov
        dtprov        TYPE c LENGTH 2,
        "! Dtamtc
        dtamtc        TYPE c LENGTH 2,
        "! Dttaxc
        dttaxc        TYPE c LENGTH 2,
        "! Dttdsp
        dttdsp        TYPE c LENGTH 2,
        "! Dtaxr
        dtaxr         TYPE c LENGTH 4,
        "! Xvatdate
        xvatdate      TYPE abap_bool,
        "! PstPerVar
        pst_per_var   TYPE abap_bool,
        "! Xbbsc
        xbbsc         TYPE abap_bool,
        "! FObsolete
        fobsolete     TYPE abap_bool,
        "! FmDeriveAcc
        fm_derive_acc TYPE abap_bool,
      END OF tys_z_i_t_001_type,
      "! <p class="shorttext synchronized">List of Z_I_T001Type</p>
      tyt_z_i_t_001_type TYPE STANDARD TABLE OF tys_z_i_t_001_type WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_T001ZType</p>
      BEGIN OF tys_z_i_t_001_ztype,
        "! <em>Key property</em> Bukrs
        bukrs TYPE c LENGTH 4,
        "! <em>Key property</em> Party
        party TYPE c LENGTH 6,
        "! Paval
        paval TYPE c LENGTH 48,
      END OF tys_z_i_t_001_ztype,
      "! <p class="shorttext synchronized">List of Z_I_T001ZType</p>
      tyt_z_i_t_001_ztype TYPE STANDARD TABLE OF tys_z_i_t_001_ztype WITH DEFAULT KEY.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Z_I_YVALIDA_FIType</p>
      BEGIN OF tys_z_i_yvalida_fitype,
        "! <em>Key property</em> Bukrs
        bukrs          TYPE c LENGTH 4,
        "! <em>Key property</em> Belnr
        belnr          TYPE c LENGTH 10,
      ...
      END OF tys_z_i_yvalida_fitype,
      "! <p class="shorttext synchronized">List of Z_I_YVALIDA_FIType</p>
      tyt_z_i_yvalida_fitype TYPE STANDARD TABLE OF tys_z_i_yvalida_fitype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_ZCRP_ACCOUNTType</p>
      BEGIN OF tys_z_i_zcrp_accounttype,
        "! <em>Key property</em> Hkont
        hkont TYPE c LENGTH 10,
      END OF tys_z_i_zcrp_accounttype,
      "! <p class="shorttext synchronized">List of Z_I_ZCRP_ACCOUNTType</p>
      tyt_z_i_zcrp_accounttype TYPE STANDARD TABLE OF tys_z_i_zcrp_accounttype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_ZCRP_CUENTAS_IMPType</p>
      BEGIN OF tys_z_i_zcrp_cuentas_imptype,
        "! <em>Key property</em> Cuenta
        cuenta      TYPE c LENGTH 10,
        "! <em>Key property</em> IndIvaSap
        ind_iva_sap TYPE c LENGTH 2,
        "! <em>Key property</em> Witht
        witht       TYPE c LENGTH 2,
        "! <em>Key property</em> WtWithcd
        wt_withcd   TYPE c LENGTH 2,
        "! Tasa
        tasa        TYPE p LENGTH 7 DECIMALS 3,
        "! TaxCode
        tax_code    TYPE c LENGTH 3,
        "! FactorType
        factor_type TYPE c LENGTH 6,
        "! Clastasa
        clastasa    TYPE c LENGTH 10,
      END OF tys_z_i_zcrp_cuentas_imptype,
      "! <p class="shorttext synchronized">List of Z_I_ZCRP_CUENTAS_IMPType</p>
      tyt_z_i_zcrp_cuentas_imptype TYPE STANDARD TABLE OF tys_z_i_zcrp_cuentas_imptype WITH DEFAULT KEY.

    TYPES:
      "! <p class="shorttext synchronized">Z_I_ZFIGLMX_CRP_AAType</p>
      BEGIN OF tys_z_i_zfiglmx_crp_aatype,
        "! <em>Key property</em> AaId
        aa_id TYPE c LENGTH 4,
        "! Lifnr
        lifnr TYPE c LENGTH 10,
      END OF tys_z_i_zfiglmx_crp_aatype,
      "! <p class="shorttext synchronized">List of Z_I_ZFIGLMX_CRP_AAType</p>
      tyt_z_i_zfiglmx_crp_aatype TYPE STANDARD TABLE OF tys_z_i_zfiglmx_crp_aatype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! Z_I_AIF_T_MVMApval
        "! <br/> Collection of type 'Z_I_AIF_T_MVMApvalType'
        z_i_aif_t_mvmapval         TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_AIF_T_MVMAPVAL',
        "! Z_I_BKPF
        ...
        "! Z_I_BSE_CLR
        "! <br/> Collection of type 'Z_I_BSE_CLRType'
        z_i_bse_clr                TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_BSE_CLR',
        "! Z_I_BUT051
        "! <br/> Collection of type 'Z_I_BUT051Type'
        z_i_but_051                TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_BUT_051',
        "! Z_I_DFKKBPTAXNUM
        "! <br/> Collection of type 'Z_I_DFKKBPTAXNUMType'
        z_i_dfkkbptaxnum           TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_DFKKBPTAXNUM',
        "! Z_I_EDOCUMENT
        "! <br/> Collection of type 'Z_I_EDOCUMENTType'
        z_i_edocument              TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_EDOCUMENT',
        "! Z_I_EDOMXINVOICE
        "! <br/> Collection of type 'Z_I_EDOMXINVOICEType'
        z_i_edomxinvoice           TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_EDOMXINVOICE',
        "! Z_I_KNA1
        ...
        "! Z_I_REGUH
        "! <br/> Collection of type 'Z_I_REGUHType'
        z_i_reguh                  TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_REGUH',
        "! Z_I_SKB1
        ...
        "! Z_I_T001
        "! <br/> Collection of type 'Z_I_T001Type'
        z_i_t_001                  TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_T_001',
        "! Z_I_T001Z
        "! <br/> Collection of type 'Z_I_T001ZType'
        z_i_t_001_z                TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_T_001_Z',
        "! Z_I_T012
        ...
        "! Z_I_YVALIDA_FI
        "! <br/> Collection of type 'Z_I_YVALIDA_FIType'
        z_i_yvalida_fi             TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_YVALIDA_FI',
        "! Z_I_ZCRP_ACCOUNT
        "! <br/> Collection of type 'Z_I_ZCRP_ACCOUNTType'
        z_i_zcrp_account           TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_ZCRP_ACCOUNT',
        "! Z_I_ZCRP_CUENTAS_IMP
        "! <br/> Collection of type 'Z_I_ZCRP_CUENTAS_IMPType'
        z_i_zcrp_cuentas_imp       TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_ZCRP_CUENTAS_IMP',
        "! Z_I_ZFIGLMX_CRP_AA
        "! <br/> Collection of type 'Z_I_ZFIGLMX_CRP_AAType'
        z_i_zfiglmx_crp_aa         TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'Z_I_ZFIGLMX_CRP_AA',
        "! Z_I_ZTASD_FACT_UUID
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_AIF_T_MVMApvalType</p>
        "! See also structure type {@link ..tys_z_i_aif_t_mvmapval_type}
        BEGIN OF z_i_aif_t_mvmapval_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_aif_t_mvmapval_type,
        ...
        BEGIN OF z_i_bsegtype,
          ...
          END OF navigation,
        END OF z_i_bsegtype,
        "! <p class="shorttext synchronized">Internal names for Z_I_BSE_CLRType</p>
        "! See also structure type {@link ..tys_z_i_bse_clrtype}
        BEGIN OF z_i_bse_clrtype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_bse_clrtype,
        "! <p class="shorttext synchronized">Internal names for Z_I_BUT051Type</p>
        "! See also structure type {@link ..tys_z_i_but_051_type}
        BEGIN OF z_i_but_051_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_but_051_type,
        "! <p class="shorttext synchronized">Internal names for Z_I_DFKKBPTAXNUMType</p>
        "! See also structure type {@link ..tys_z_i_dfkkbptaxnumtype}
        BEGIN OF z_i_dfkkbptaxnumtype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_dfkkbptaxnumtype,
        "! <p class="shorttext synchronized">Internal names for Z_I_EDOCUMENTType</p>
        "! See also structure type {@link ..tys_z_i_edocumenttype}
        BEGIN OF z_i_edocumenttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_edocumenttype,
        "! <p class="shorttext synchronized">Internal names for Z_I_EDOMXINVOICEType</p>
        "! See also structure type {@link ..tys_z_i_edomxinvoicetype}
        BEGIN OF z_i_edomxinvoicetype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_edomxinvoicetype,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_REGUHType</p>
        "! See also structure type {@link ..tys_z_i_reguhtype}
        BEGIN OF z_i_reguhtype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_reguhtype,
        ...
        BEGIN OF z_i_stxhtype,
          ...
          END OF navigation,
        END OF z_i_stxhtype,
        "! <p class="shorttext synchronized">Internal names for Z_I_T001Type</p>
        "! See also structure type {@link ..tys_z_i_t_001_type}
        BEGIN OF z_i_t_001_type,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_t_001_type,
        "! <p class="shorttext synchronized">Internal names for Z_I_T001ZType</p>
        "! See also structure type {@link ..tys_z_i_t_001_ztype}
        BEGIN OF z_i_t_001_ztype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_t_001_ztype,
        ...
        "! <p class="shorttext synchronized">Internal names for Z_I_YVALIDA_FIType</p>
        "! See also structure type {@link ..tys_z_i_yvalida_fitype}
        BEGIN OF z_i_yvalida_fitype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_yvalida_fitype,
        "! <p class="shorttext synchronized">Internal names for Z_I_ZCRP_ACCOUNTType</p>
        "! See also structure type {@link ..tys_z_i_zcrp_accounttype}
        BEGIN OF z_i_zcrp_accounttype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_zcrp_accounttype,
        "! <p class="shorttext synchronized">Internal names for Z_I_ZCRP_CUENTAS_IMPType</p>
        "! See also structure type {@link ..tys_z_i_zcrp_cuentas_imptype}
        BEGIN OF z_i_zcrp_cuentas_imptype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_zcrp_cuentas_imptype,
        "! <p class="shorttext synchronized">Internal names for Z_I_ZFIGLMX_CRP_AAType</p>
        "! See also structure type {@link ..tys_z_i_zfiglmx_crp_aatype}
        BEGIN OF z_i_zfiglmx_crp_aatype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF z_i_zfiglmx_crp_aatype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define Z_I_AIF_T_MVMApvalType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_aif_t_mvmapval_type RAISING /iwbep/cx_gateway.
    ...
    "! <p class="shorttext synchronized">Define Z_I_BSE_CLRType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_bse_clrtype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_BUT051Type</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_but_051_type RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_DFKKBPTAXNUMType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_dfkkbptaxnumtype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_EDOCUMENTType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_edocumenttype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_EDOMXINVOICEType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_edomxinvoicetype RAISING /iwbep/cx_gateway.
    ...
    "! <p class="shorttext synchronized">Define Z_I_REGUHType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_reguhtype RAISING /iwbep/cx_gateway.
    ...
    "! <p class="shorttext synchronized">Define Z_I_T001Type</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_t_001_type RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_T001ZType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_t_001_ztype RAISING /iwbep/cx_gateway.
    ...
    "! <p class="shorttext synchronized">Define Z_I_YVALIDA_FIType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_yvalida_fitype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_ZCRP_ACCOUNTType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_zcrp_accounttype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_ZCRP_CUENTAS_IMPType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_zcrp_cuentas_imptype RAISING /iwbep/cx_gateway.

    "! <p class="shorttext synchronized">Define Z_I_ZFIGLMX_CRP_AAType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_z_i_zfiglmx_crp_aatype RAISING /iwbep/cx_gateway.
...
CLASS ZSCM_ZFIGLMX_JOURNAL_DETAIL IMPLEMENTATION.


  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zsd_zfiglmx_crp_journal_detail' ) ##NO_TEXT.
    ...
    def_z_i_adrctype( ).
    def_z_i_adr_6_type( ).
    def_z_i_aif_t_mvmapval_type( ).
    def_z_i_bkpftype( ).
    def_z_i_bnkatype( ).
    def_z_i_bsegtype( ).
    def_z_i_bse_clrtype( ).
    def_z_i_but_051_type( ).
    def_z_i_dfkkbptaxnumtype( ).
    def_z_i_edocumenttype( ).
    def_z_i_edomxinvoicetype( ).
    def_z_i_kna_1_type( ).
    def_z_i_knvktype( ).
    def_z_i_lfa_1_type( ).
    def_z_i_reguhtype( ).
    ...
    def_z_i_yvalida_fitype( ).
    def_z_i_zcrp_accounttype( ).
    def_z_i_zcrp_cuentas_imptype( ).
    def_z_i_zfiglmx_crp_aatype( ).
  ...
  METHOD def_z_i_aif_t_mvmapval_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_AIF_T_MVMAPVAL_TYPE'
                                    is_structure              = VALUE tys_z_i_aif_t_mvmapval_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_AIF_T_MVMApvalType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_AIF_T_MVMAPVAL' ).
    lo_entity_set->set_edm_name( 'Z_I_AIF_T_MVMApval' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'NS' ).
    lo_primitive_property->set_edm_name( 'Ns' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VMAPNAME' ).
    lo_primitive_property->set_edm_name( 'Vmapname' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VMAPVALNR' ).
    lo_primitive_property->set_edm_name( 'Vmapvalnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'EXT_VALUE' ).
    lo_primitive_property->set_edm_name( 'ExtValue' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 200 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INT_VALUE' ).
    lo_primitive_property->set_edm_name( 'IntValue' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 200 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DEFAULT_FLAG' ).
    lo_primitive_property->set_edm_name( 'DefaultFlag' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SENDING_SYSTEM' ).
    lo_primitive_property->set_edm_name( 'SendingSystem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 60 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GROUP_ID' ).
    lo_primitive_property->set_edm_name( 'GroupId' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 32 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VALID_PERIOD_NO' ).
    lo_primitive_property->set_edm_name( 'ValidPeriodNo' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_bse_clrtype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_BSE_CLRTYPE'
                                    is_structure              = VALUE tys_z_i_bse_clrtype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_BSE_CLRType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_BSE_CLR' ).
    lo_entity_set->set_edm_name( 'Z_I_BSE_CLR' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'BUKRS_CLR' ).
    lo_primitive_property->set_edm_name( 'BukrsClr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BELNR_CLR' ).
    lo_primitive_property->set_edm_name( 'BelnrClr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GJAHR_CLR' ).
    lo_primitive_property->set_edm_name( 'GjahrClr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INDEX_CLR' ).
    lo_primitive_property->set_edm_name( 'IndexClr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'AGBUZ' ).
    lo_primitive_property->set_edm_name( 'Agbuz' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'CLRIN' ).
    lo_primitive_property->set_edm_name( 'Clrin' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DIFHW' ).
    lo_primitive_property->set_edm_name( 'Difhw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DIFH_2' ).
    lo_primitive_property->set_edm_name( 'Difh2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DIFH_3' ).
    lo_primitive_property->set_edm_name( 'Difh3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DIFFW' ).
    lo_primitive_property->set_edm_name( 'Diffw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'WAERS_OP' ).
    lo_primitive_property->set_edm_name( 'WaersOp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WSKTO_OP' ).
    lo_primitive_property->set_edm_name( 'WsktoOp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_but_051_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_BUT_051_TYPE'
                                    is_structure              = VALUE tys_z_i_but_051_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_BUT051Type' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_BUT_051' ).
    lo_entity_set->set_edm_name( 'Z_I_BUT051' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'RELNR' ).
    lo_primitive_property->set_edm_name( 'Relnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PARTNER_1' ).
    lo_primitive_property->set_edm_name( 'Partner1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PARTNER_2' ).
    lo_primitive_property->set_edm_name( 'Partner2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'RELTYP' ).
    lo_primitive_property->set_edm_name( 'Reltyp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XRF' ).
    lo_primitive_property->set_edm_name( 'Xrf' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FNCTN' ).
    lo_primitive_property->set_edm_name( 'Fnctn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DPRTMNT' ).
    lo_primitive_property->set_edm_name( 'Dprtmnt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PAAUTH' ).
    lo_primitive_property->set_edm_name( 'Paauth' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PAREM' ).
    lo_primitive_property->set_edm_name( 'Parem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 40 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SMTP_ADDRESS' ).
    lo_primitive_property->set_edm_name( 'SmtpAddress' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 241 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REL_PER' ).
    lo_primitive_property->set_edm_name( 'RelPer' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 7 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REL_AMO' ).
    lo_primitive_property->set_edm_name( 'RelAmo' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REL_CUR' ).
    lo_primitive_property->set_edm_name( 'RelCur' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CALL_RULEID' ).
    lo_primitive_property->set_edm_name( 'CallRuleid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 25 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VISIT_RULEID' ).
    lo_primitive_property->set_edm_name( 'VisitRuleid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 25 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CALL_GUID' ).
    lo_primitive_property->set_edm_name( 'CallGuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'VISIT_GUID' ).
    lo_primitive_property->set_edm_name( 'VisitGuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BP_EEW_BUT_051' ).
    lo_primitive_property->set_edm_name( 'BpEewBut051' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BP_EEW_BUT_051_SP' ).
    lo_primitive_property->set_edm_name( 'BpEewBut051Sp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_dfkkbptaxnumtype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_DFKKBPTAXNUMTYPE'
                                    is_structure              = VALUE tys_z_i_dfkkbptaxnumtype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_DFKKBPTAXNUMType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_DFKKBPTAXNUM' ).
    lo_entity_set->set_edm_name( 'Z_I_DFKKBPTAXNUM' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'TAXTYPE' ).
    lo_primitive_property->set_edm_name( 'Taxtype' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TAXNUM' ).
    lo_primitive_property->set_edm_name( 'Taxnum' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TAXNUMXL' ).
    lo_primitive_property->set_edm_name( 'Taxnumxl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 60 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_edocumenttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_EDOCUMENTTYPE'
                                    is_structure              = VALUE tys_z_i_edocumenttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_EDOCUMENTType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_EDOCUMENT' ).
    lo_entity_set->set_edm_name( 'Z_I_EDOCUMENT' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDOC_GUID' ).
    lo_primitive_property->set_edm_name( 'EdocGuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SEQ_NO' ).
    lo_primitive_property->set_edm_name( 'SeqNo' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'LAND' ).
    lo_primitive_property->set_edm_name( 'Land' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SOURCE_TYPE' ).
    lo_primitive_property->set_edm_name( 'SourceType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDOC_TYPE' ).
    lo_primitive_property->set_edm_name( 'EdocType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROC_STATUS' ).
    lo_primitive_property->set_edm_name( 'ProcStatus' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'CHANGE_DATE' ).
    lo_primitive_property->set_edm_name( 'ChangeDate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CHANGE_TIME' ).
    lo_primitive_property->set_edm_name( 'ChangeTime' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'Time' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'CREATE_DATE' ).
    lo_primitive_property->set_edm_name( 'CreateDate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CREATE_TIME' ).
    lo_primitive_property->set_edm_name( 'CreateTime' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'TimeOfDay' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'Time' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SOURCE_CREATED_BY' ).
    lo_primitive_property->set_edm_name( 'SourceCreatedBy' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROCESS' ).
    lo_primitive_property->set_edm_name( 'Process' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'LAST_PROCSTEP' ).
    lo_primitive_property->set_edm_name( 'LastProcstep' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'LAST_PROCSTEP_VARIANT' ).
    lo_primitive_property->set_edm_name( 'LastProcstepVariant' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PROCESS_VERSION' ).
    lo_primitive_property->set_edm_name( 'ProcessVersion' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DOCREF_SEQNR' ).
    lo_primitive_property->set_edm_name( 'DocrefSeqnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'CONTINGENCY' ).
    lo_primitive_property->set_edm_name( 'Contingency' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'METASTATUS' ).
    lo_primitive_property->set_edm_name( 'Metastatus' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REF_PROCESS' ).
    lo_primitive_property->set_edm_name( 'RefProcess' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDOCUMENT_CLASS' ).
    lo_primitive_property->set_edm_name( 'EdocumentClass' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ARCHIVE_PREP' ).
    lo_primitive_property->set_edm_name( 'ArchivePrep' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INTERFACE_TYPE' ).
    lo_primitive_property->set_edm_name( 'InterfaceType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'APPROVAL_ID' ).
    lo_primitive_property->set_edm_name( 'ApprovalId' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INTERFACE_GUID' ).
    lo_primitive_property->set_edm_name( 'InterfaceGuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FILE_GUID' ).
    lo_primitive_property->set_edm_name( 'FileGuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RESPONSE_CODE' ).
    lo_primitive_property->set_edm_name( 'ResponseCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INTERFACE_ID' ).
    lo_primitive_property->set_edm_name( 'InterfaceId' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INT_VERSION' ).
    lo_primitive_property->set_edm_name( 'IntVersion' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'COUNT_ARCHIVE' ).
    lo_primitive_property->set_edm_name( 'CountArchive' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_edomxinvoicetype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_EDOMXINVOICETYPE'
                                    is_structure              = VALUE tys_z_i_edomxinvoicetype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_EDOMXINVOICEType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_EDOMXINVOICE' ).
    lo_entity_set->set_edm_name( 'Z_I_EDOMXINVOICE' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DOC_NUM_PREFIX' ).
    lo_primitive_property->set_edm_name( 'DocNumPrefix' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DOC_NUM' ).
    lo_primitive_property->set_edm_name( 'DocNum' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'TAX_ID_OF_PAC' ).
    lo_primitive_property->set_edm_name( 'TaxIdOfPac' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DIGEST_VALUE' ).
    lo_primitive_property->set_edm_name( 'DigestValue' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TRANS_ID' ).
    lo_primitive_property->set_edm_name( 'TransId' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CANCLREASNCODE' ).
    lo_primitive_property->set_edm_name( 'Canclreasncode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SUBSTITUTE_UUID' ).
    lo_primitive_property->set_edm_name( 'SubstituteUuid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 36 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_reguhtype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_REGUHTYPE'
                                    is_structure              = VALUE tys_z_i_reguhtype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_REGUHType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_REGUH' ).
    lo_entity_set->set_edm_name( 'Z_I_REGUH' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'LAUFD' ).
    lo_primitive_property->set_edm_name( 'Laufd' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_key( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'LAUFI' ).
    lo_primitive_property->set_edm_name( 'Laufi' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XVORL' ).
    lo_primitive_property->set_edm_name( 'Xvorl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBUKR' ).
    lo_primitive_property->set_edm_name( 'Zbukr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'VBLNR' ).
    lo_primitive_property->set_edm_name( 'Vblnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'AVISG' ).
    lo_primitive_property->set_edm_name( 'Avisg' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SRTGB' ).
    lo_primitive_property->set_edm_name( 'Srtgb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEVWV' ).
    lo_primitive_property->set_edm_name( 'Wevwv' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZANRE' ).
    lo_primitive_property->set_edm_name( 'Zanre' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZNME_1' ).
    lo_primitive_property->set_edm_name( 'Znme1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZNME_2' ).
    lo_primitive_property->set_edm_name( 'Znme2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZNME_3' ).
    lo_primitive_property->set_edm_name( 'Znme3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZNME_4' ).
    lo_primitive_property->set_edm_name( 'Znme4' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZPSTL' ).
    lo_primitive_property->set_edm_name( 'Zpstl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZORT_1' ).
    lo_primitive_property->set_edm_name( 'Zort1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZSTRA' ).
    lo_primitive_property->set_edm_name( 'Zstra' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZPFAC' ).
    lo_primitive_property->set_edm_name( 'Zpfac' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZLAND' ).
    lo_primitive_property->set_edm_name( 'Zland' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZREGI' ).
    lo_primitive_property->set_edm_name( 'Zregi' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBNKS' ).
    lo_primitive_property->set_edm_name( 'Zbnks' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBNKN' ).
    lo_primitive_property->set_edm_name( 'Zbnkn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBNKN_LONG' ).
    lo_primitive_property->set_edm_name( 'ZbnknLong' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBNKL' ).
    lo_primitive_property->set_edm_name( 'Zbnkl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBKON' ).
    lo_primitive_property->set_edm_name( 'Zbkon' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBVTY' ).
    lo_primitive_property->set_edm_name( 'Zbvty' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZSWIF' ).
    lo_primitive_property->set_edm_name( 'Zswif' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 11 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZSPRA' ).
    lo_primitive_property->set_edm_name( 'Zspra' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZALDT' ).
    lo_primitive_property->set_edm_name( 'Zaldt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RZAWE' ).
    lo_primitive_property->set_edm_name( 'Rzawe' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RUMSK' ).
    lo_primitive_property->set_edm_name( 'Rumsk' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RZUMS' ).
    lo_primitive_property->set_edm_name( 'Rzums' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'HKTIW' ).
    lo_primitive_property->set_edm_name( 'Hktiw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'HBKIW' ).
    lo_primitive_property->set_edm_name( 'Hbkiw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBKON' ).
    lo_primitive_property->set_edm_name( 'Ubkon' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBKNT' ).
    lo_primitive_property->set_edm_name( 'Ubknt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBKNT_LONG' ).
    lo_primitive_property->set_edm_name( 'UbkntLong' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBNKS' ).
    lo_primitive_property->set_edm_name( 'Ubnks' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBNKL' ).
    lo_primitive_property->set_edm_name( 'Ubnkl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UIBAN' ).
    lo_primitive_property->set_edm_name( 'Uiban' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 34 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBHKT' ).
    lo_primitive_property->set_edm_name( 'Ubhkt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'CRVAL' ).
    lo_primitive_property->set_edm_name( 'Crval' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEFAE' ).
    lo_primitive_property->set_edm_name( 'Wefae' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RBETR' ).
    lo_primitive_property->set_edm_name( 'Rbetr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSKON' ).
    lo_primitive_property->set_edm_name( 'Rskon' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RWBTR' ).
    lo_primitive_property->set_edm_name( 'Rwbtr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RWSKT' ).
    lo_primitive_property->set_edm_name( 'Rwskt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSPE_1' ).
    lo_primitive_property->set_edm_name( 'Rspe1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSPE_2' ).
    lo_primitive_property->set_edm_name( 'Rspe2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RPOST' ).
    lo_primitive_property->set_edm_name( 'Rpost' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RTEXT' ).
    lo_primitive_property->set_edm_name( 'Rtext' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSPM_1' ).
    lo_primitive_property->set_edm_name( 'Rspm1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSPM_2' ).
    lo_primitive_property->set_edm_name( 'Rspm2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEHMX' ).
    lo_primitive_property->set_edm_name( 'Wehmx' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEFMX' ).
    lo_primitive_property->set_edm_name( 'Wefmx' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEHRS' ).
    lo_primitive_property->set_edm_name( 'Wehrs' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEFRS' ).
    lo_primitive_property->set_edm_name( 'Wefrs' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WEAMX' ).
    lo_primitive_property->set_edm_name( 'Weamx' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'WDATE' ).
    lo_primitive_property->set_edm_name( 'Wdate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XAEND' ).
    lo_primitive_property->set_edm_name( 'Xaend' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SKVHW' ).
    lo_primitive_property->set_edm_name( 'Skvhw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SKVFW' ).
    lo_primitive_property->set_edm_name( 'Skvfw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DSKVH' ).
    lo_primitive_property->set_edm_name( 'Dskvh' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZPST_2' ).
    lo_primitive_property->set_edm_name( 'Zpst2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PAYGR' ).
    lo_primitive_property->set_edm_name( 'Paygr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBNKY' ).
    lo_primitive_property->set_edm_name( 'Zbnky' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UBNKY' ).
    lo_primitive_property->set_edm_name( 'Ubnky' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ABSBU' ).
    lo_primitive_property->set_edm_name( 'Absbu' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RBET_2' ).
    lo_primitive_property->set_edm_name( 'Rbet2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RBET_3' ).
    lo_primitive_property->set_edm_name( 'Rbet3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSKO_2' ).
    lo_primitive_property->set_edm_name( 'Rsko2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RSKO_3' ).
    lo_primitive_property->set_edm_name( 'Rsko3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'KURS_2' ).
    lo_primitive_property->set_edm_name( 'Kurs2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 9 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'KURS_3_F' ).
    lo_primitive_property->set_edm_name( 'Kurs3f' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 9 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZORT_2' ).
    lo_primitive_property->set_edm_name( 'Zort2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZTLFX' ).
    lo_primitive_property->set_edm_name( 'Ztlfx' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 31 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XSIWE' ).
    lo_primitive_property->set_edm_name( 'Xsiwe' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZPFOR' ).
    lo_primitive_property->set_edm_name( 'Zpfor' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 35 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SEQNR' ).
    lo_primitive_property->set_edm_name( 'Seqnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 5 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BTZNR' ).
    lo_primitive_property->set_edm_name( 'Btznr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Binary' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'AUSFD' ).
    lo_primitive_property->set_edm_name( 'Ausfd' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDIAV' ).
    lo_primitive_property->set_edm_name( 'Ediav' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IDOC_NUM_AVIS' ).
    lo_primitive_property->set_edm_name( 'IdocNumAvis' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'EDIBN' ).
    lo_primitive_property->set_edm_name( 'Edibn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IDOC_NUM' ).
    lo_primitive_property->set_edm_name( 'IdocNum' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZTELF' ).
    lo_primitive_property->set_edm_name( 'Ztelf' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZTELX' ).
    lo_primitive_property->set_edm_name( 'Ztelx' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 30 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZSTC_1' ).
    lo_primitive_property->set_edm_name( 'Zstc1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 16 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PYORD' ).
    lo_primitive_property->set_edm_name( 'Pyord' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property->set_edm_name( 'Text' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 29 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BTYP_1' ).
    lo_primitive_property->set_edm_name( 'Btyp1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKS_1' ).
    lo_primitive_property->set_edm_name( 'Bnks1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKL_1' ).
    lo_primitive_property->set_edm_name( 'Bnkl1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKN_1' ).
    lo_primitive_property->set_edm_name( 'Bnkn1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BKON_1' ).
    lo_primitive_property->set_edm_name( 'Bkon1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BKRF_1' ).
    lo_primitive_property->set_edm_name( 'Bkrf1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IBAN_1' ).
    lo_primitive_property->set_edm_name( 'Iban1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 34 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BTYP_2' ).
    lo_primitive_property->set_edm_name( 'Btyp2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKS_2' ).
    lo_primitive_property->set_edm_name( 'Bnks2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKL_2' ).
    lo_primitive_property->set_edm_name( 'Bnkl2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'BKON_2' ).
    lo_primitive_property->set_edm_name( 'Bkon2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BKRF_2' ).
    lo_primitive_property->set_edm_name( 'Bkrf2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IBAN_2' ).
    lo_primitive_property->set_edm_name( 'Iban2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 34 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BTYP_3' ).
    lo_primitive_property->set_edm_name( 'Btyp3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKS_3' ).
    lo_primitive_property->set_edm_name( 'Bnks3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKL_3' ).
    lo_primitive_property->set_edm_name( 'Bnkl3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BNKN_3' ).
    lo_primitive_property->set_edm_name( 'Bnkn3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 18 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BKON_3' ).
    lo_primitive_property->set_edm_name( 'Bkon3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BKRF_3' ).
    lo_primitive_property->set_edm_name( 'Bkrf3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IBAN_3' ).
    lo_primitive_property->set_edm_name( 'Iban3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 34 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ALEBN' ).
    lo_primitive_property->set_edm_name( 'Alebn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XKDFB' ).
    lo_primitive_property->set_edm_name( 'Xkdfb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SRTBP' ).
    lo_primitive_property->set_edm_name( 'Srtbp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FPM_KEY' ).
    lo_primitive_property->set_edm_name( 'FpmKey' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GRPNO' ).
    lo_primitive_property->set_edm_name( 'Grpno' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Int32' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SRTF_1' ).
    lo_primitive_property->set_edm_name( 'Srtf1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 38 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SRTF_2' ).
    lo_primitive_property->set_edm_name( 'Srtf2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 56 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SRTF_3' ).
    lo_primitive_property->set_edm_name( 'Srtf3' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 38 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XCORR' ).
    lo_primitive_property->set_edm_name( 'Xcorr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XAVIS' ).
    lo_primitive_property->set_edm_name( 'Xavis' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XCOPM' ).
    lo_primitive_property->set_edm_name( 'Xcopm' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DORIGIN' ).
    lo_primitive_property->set_edm_name( 'Dorigin' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 8 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RFTTRN' ).
    lo_primitive_property->set_edm_name( 'Rfttrn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZADNR' ).
    lo_primitive_property->set_edm_name( 'Zadnr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZIBAN' ).
    lo_primitive_property->set_edm_name( 'Ziban' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 34 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MGUID' ).
    lo_primitive_property->set_edm_name( 'Mguid' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Guid' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SEQ_TYPE' ).
    lo_primitive_property->set_edm_name( 'SeqType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INST_CODE' ).
    lo_primitive_property->set_edm_name( 'InstCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PURP_CODE' ).
    lo_primitive_property->set_edm_name( 'PurpCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XMLST' ).
    lo_primitive_property->set_edm_name( 'Xmlst' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TIMESTAMP_AVIS' ).
    lo_primitive_property->set_edm_name( 'TimestampAvis' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UETR' ).
    lo_primitive_property->set_edm_name( 'Uetr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 36 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZPAYMENT_SYSTEM' ).
    lo_primitive_property->set_edm_name( 'ZpaymentSystem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZALIAS_TYPE' ).
    lo_primitive_property->set_edm_name( 'ZaliasType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 15 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ZBANK_ALIAS' ).
    lo_primitive_property->set_edm_name( 'ZbankAlias' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 255 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FM_STATUS' ).
    lo_primitive_property->set_edm_name( 'FmStatus' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FILE_NBR' ).
    lo_primitive_property->set_edm_name( 'FileNbr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_t_001_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_T_001_TYPE'
                                    is_structure              = VALUE tys_z_i_t_001_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_T001Type' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_T_001' ).
    lo_entity_set->set_edm_name( 'Z_I_T001' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'BUTXT' ).
    lo_primitive_property->set_edm_name( 'Butxt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 25 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'KTOPL' ).
    lo_primitive_property->set_edm_name( 'Ktopl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WAABW' ).
    lo_primitive_property->set_edm_name( 'Waabw' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'KOKFI' ).
    lo_primitive_property->set_edm_name( 'Kokfi' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'RCOMP' ).
    lo_primitive_property->set_edm_name( 'Rcomp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'XFMCO' ).
    lo_primitive_property->set_edm_name( 'Xfmco' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XFMCB' ).
    lo_primitive_property->set_edm_name( 'Xfmcb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XFMCA' ).
    lo_primitive_property->set_edm_name( 'Xfmca' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'FMHRDATE' ).
    lo_primitive_property->set_edm_name( 'Fmhrdate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Date' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    lo_primitive_property->set_edm_type_v2( 'DateTime' ) ##NO_TEXT.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XTEMPLT' ).
    lo_primitive_property->set_edm_name( 'Xtemplt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TRANSIT_PLANT' ).
    lo_primitive_property->set_edm_name( 'TransitPlant' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BUVAR' ).
    lo_primitive_property->set_edm_name( 'Buvar' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FDBUK' ).
    lo_primitive_property->set_edm_name( 'Fdbuk' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XFDIS' ).
    lo_primitive_property->set_edm_name( 'Xfdis' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XVALV' ).
    lo_primitive_property->set_edm_name( 'Xvalv' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XSKFN' ).
    lo_primitive_property->set_edm_name( 'Xskfn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'XMWSN' ).
    lo_primitive_property->set_edm_name( 'Xmwsn' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MREGL' ).
    lo_primitive_property->set_edm_name( 'Mregl' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XGSBE' ).
    lo_primitive_property->set_edm_name( 'Xgsbe' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XGJRV' ).
    lo_primitive_property->set_edm_name( 'Xgjrv' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XKDFT' ).
    lo_primitive_property->set_edm_name( 'Xkdft' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XPROD' ).
    lo_primitive_property->set_edm_name( 'Xprod' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XEINK' ).
    lo_primitive_property->set_edm_name( 'Xeink' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XJVAA' ).
    lo_primitive_property->set_edm_name( 'Xjvaa' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XVVWA' ).
    lo_primitive_property->set_edm_name( 'Xvvwa' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XSLTA' ).
    lo_primitive_property->set_edm_name( 'Xslta' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XFDMM' ).
    lo_primitive_property->set_edm_name( 'Xfdmm' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XFDSD' ).
    lo_primitive_property->set_edm_name( 'Xfdsd' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XEXTB' ).
    lo_primitive_property->set_edm_name( 'Xextb' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'EBUKR' ).
    lo_primitive_property->set_edm_name( 'Ebukr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'KTOP_2' ).
    lo_primitive_property->set_edm_name( 'Ktop2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'UMKRS' ).
    lo_primitive_property->set_edm_name( 'Umkrs' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BUKRS_GLOB' ).
    lo_primitive_property->set_edm_name( 'BukrsGlob' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FSTVA' ).
    lo_primitive_property->set_edm_name( 'Fstva' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OPVAR' ).
    lo_primitive_property->set_edm_name( 'Opvar' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XCOVR' ).
    lo_primitive_property->set_edm_name( 'Xcovr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'WFVAR' ).
    lo_primitive_property->set_edm_name( 'Wfvar' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XBBBF' ).
    lo_primitive_property->set_edm_name( 'Xbbbf' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XBBBE' ).
    lo_primitive_property->set_edm_name( 'Xbbbe' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XBBBA' ).
    lo_primitive_property->set_edm_name( 'Xbbba' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XBBKO' ).
    lo_primitive_property->set_edm_name( 'Xbbko' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XSTDT' ).
    lo_primitive_property->set_edm_name( 'Xstdt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MWSKV' ).
    lo_primitive_property->set_edm_name( 'Mwskv' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MWSKA' ).
    lo_primitive_property->set_edm_name( 'Mwska' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IMPDA' ).
    lo_primitive_property->set_edm_name( 'Impda' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'XKKBI' ).
    lo_primitive_property->set_edm_name( 'Xkkbi' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'WT_NEWWT' ).
    lo_primitive_property->set_edm_name( 'WtNewwt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PP_PDATE' ).
    lo_primitive_property->set_edm_name( 'PpPdate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INFMT' ).
    lo_primitive_property->set_edm_name( 'Infmt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FSTVARE' ).
    lo_primitive_property->set_edm_name( 'Fstvare' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'KOPIM' ).
    lo_primitive_property->set_edm_name( 'Kopim' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DKWEG' ).
    lo_primitive_property->set_edm_name( 'Dkweg' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'OFFSACCT' ).
    lo_primitive_property->set_edm_name( 'Offsacct' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'BAPOVAR' ).
    lo_primitive_property->set_edm_name( 'Bapovar' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XCOS' ).
    lo_primitive_property->set_edm_name( 'Xcos' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XCESSION' ).
    lo_primitive_property->set_edm_name( 'Xcession' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XSPLT' ).
    lo_primitive_property->set_edm_name( 'Xsplt' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SURCCM' ).
    lo_primitive_property->set_edm_name( 'Surccm' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DTPROV' ).
    lo_primitive_property->set_edm_name( 'Dtprov' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DTAMTC' ).
    lo_primitive_property->set_edm_name( 'Dtamtc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DTTAXC' ).
    lo_primitive_property->set_edm_name( 'Dttaxc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DTTDSP' ).
    lo_primitive_property->set_edm_name( 'Dttdsp' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DTAXR' ).
    lo_primitive_property->set_edm_name( 'Dtaxr' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XVATDATE' ).
    lo_primitive_property->set_edm_name( 'Xvatdate' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PST_PER_VAR' ).
    lo_primitive_property->set_edm_name( 'PstPerVar' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'XBBSC' ).
    lo_primitive_property->set_edm_name( 'Xbbsc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FOBSOLETE' ).
    lo_primitive_property->set_edm_name( 'FObsolete' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'FM_DERIVE_ACC' ).
    lo_primitive_property->set_edm_name( 'FmDeriveAcc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_t_001_ztype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_T_001_ZTYPE'
                                    is_structure              = VALUE tys_z_i_t_001_ztype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_T001ZType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_T_001_Z' ).
    lo_entity_set->set_edm_name( 'Z_I_T001Z' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'PARTY' ).
    lo_primitive_property->set_edm_name( 'Party' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'PAVAL' ).
    lo_primitive_property->set_edm_name( 'Paval' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
  ...
  METHOD def_z_i_yvalida_fitype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_YVALIDA_FITYPE'
                                    is_structure              = VALUE tys_z_i_yvalida_fitype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_YVALIDA_FIType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_YVALIDA_FI' ).
    lo_entity_set->set_edm_name( 'Z_I_YVALIDA_FI' ) ##NO_TEXT.
  ...
  METHOD def_z_i_zcrp_accounttype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_ZCRP_ACCOUNTTYPE'
                                    is_structure              = VALUE tys_z_i_zcrp_accounttype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_ZCRP_ACCOUNTType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_ZCRP_ACCOUNT' ).
    lo_entity_set->set_edm_name( 'Z_I_ZCRP_ACCOUNT' ) ##NO_TEXT.
  ...
  METHOD def_z_i_zcrp_cuentas_imptype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_ZCRP_CUENTAS_IMPTYPE'
                                    is_structure              = VALUE tys_z_i_zcrp_cuentas_imptype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_ZCRP_CUENTAS_IMPType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_ZCRP_CUENTAS_IMP' ).
    lo_entity_set->set_edm_name( 'Z_I_ZCRP_CUENTAS_IMP' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'CUENTA' ).
    lo_primitive_property->set_edm_name( 'Cuenta' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'IND_IVA_SAP' ).
    lo_primitive_property->set_edm_name( 'IndIvaSap' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'TASA' ).
    lo_primitive_property->set_edm_name( 'Tasa' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 12 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'FACTOR_TYPE' ).
    lo_primitive_property->set_edm_name( 'FactorType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CLASTASA' ).
    lo_primitive_property->set_edm_name( 'Clastasa' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
  ...
  METHOD def_z_i_zfiglmx_crp_aatype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'Z_I_ZFIGLMX_CRP_AATYPE'
                                    is_structure              = VALUE tys_z_i_zfiglmx_crp_aatype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'Z_I_ZFIGLMX_CRP_AAType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'Z_I_ZFIGLMX_CRP_AA' ).
    lo_entity_set->set_edm_name( 'Z_I_ZFIGLMX_CRP_AA' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'AA_ID' ).
    lo_primitive_property->set_edm_name( 'AaId' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).
